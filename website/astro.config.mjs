      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'S3', items: [{ autogenerate: { directory: 'reference/s3' } }] },
            { label: 'Cloudflare', items: [{ autogenerate: { directory: 'reference/cloudflare' } }] },
            { label: 'KV (Redis)', items: [{ autogenerate: { directory: 'reference/kv' } }] },
