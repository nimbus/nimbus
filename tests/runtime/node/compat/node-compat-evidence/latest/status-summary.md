...
| `node26` | `current` | `v26.2.0` | 5578 | 2056 | 3470 | 52 | 3522 | 5578 | 0 | 36.9% |

## Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? | Notes |
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7736 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 153 catalog_entry_count | - | - | no | Ignored Rust watchpoints and expectation catalog entries used to preserve known failures and unexpected-pass diagnostics. |
...
| `node26` | `tests/runtime/node/classifications/node26.json` | 3470 | 52 | 3522 | `{"Known gap": 3470, "Skipped / excluded": 52}` | `{"Requires Native Addon Harness": 34, "Requires Pseudo Tty Host Harness": 32, "Requires Pummel Stress Harness": 65, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 3172, "Requires Wpt Harness": 25, "Support Fixture Not Top Level Test": 46, "Upstream Known Issue Or Platform Boundary": 29}` |
...
- ignored Rust node_compat tests: 153
...
- entries: 153
- by expectation: `{"Expected failure": 153}`
- by classification: `{"Watchpoint": 153}`
- unexpected passes: 0
