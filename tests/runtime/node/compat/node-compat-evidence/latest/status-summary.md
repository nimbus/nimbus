...
| `node22` | `supported` | `v22.22.3` | 4748 | 2300 | 2428 | 20 | 2448 | 4748 | 0 | 48.4% |
| `node24` | `default` | `v24.16.0` | 5198 | 2330 | 2820 | 48 | 2868 | 5198 | 0 | 44.8% |
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6556 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `node22` | `tests/runtime/node/classifications/node22.json` | 2428 | 20 | 2448 | `{"Expected failure": 24, "Known gap": 2404, "Skipped / excluded": 20}` | `{"Requires Native Addon Harness": 29, "Requires Pseudo Tty Host Harness": 30, "Requires Pummel Stress Harness": 55, "Requires Sequential Host State Harness": 115, "Requires Unpromoted Node Surface": 2127, "Requires Wpt Harness": 22, "Rust Watchpoint Expected Failure": 24, "Support Fixture Not Top Level Test": 20, "Upstream Known Issue Or Platform Boundary": 26}` |
| `node24` | `tests/runtime/node/classifications/node24.json` | 2820 | 48 | 2868 | `{"Expected failure": 6, "Known gap": 2814, "Skipped / excluded": 48}` | `{"Requires Native Addon Harness": 31, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 64, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 2523, "Requires Wpt Harness": 23, "Rust Watchpoint Expected Failure": 6, "Support Fixture Not Top Level Test": 47, "Upstream Known Issue Or Platform Boundary": 24}` |
