...
| `node26` | `current` | `v26.2.0` | 5578 | 1890 | 3642 | 46 | 3688 | 5578 | 0 | 33.9% |

## Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? | Notes |
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7570 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `node26` | `tests/runtime/node/classifications/node26.json` | 3642 | 46 | 3688 | `{"Expected failure": 34, "Known gap": 3608, "Skipped / excluded": 46}` | `{"Node26 Current Broad Pre Run Residual": 34, "Requires Native Addon Harness": 33, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 65, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 3312, "Requires Wpt Harness": 25, "Support Fixture Not Top Level Test": 46, "Upstream Known Issue Or Platform Boundary": 23}` |
