...
| `node22` | `supported` | `v22.22.3` | 4748 | 2328 | 2400 | 20 | 2420 | 4748 | 0 | 49.0% |
| `node24` | `default` | `v24.16.0` | 5198 | 2358 | 2792 | 48 | 2840 | 5198 | 0 | 45.4% |
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6612 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `node22` | `tests/runtime/node/classifications/node22.json` | 2400 | 20 | 2420 | `{"Expected failure": 22, "Known gap": 2378, "Skipped / excluded": 20}` | `{"Requires Native Addon Harness": 29, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 55, "Requires Sequential Host State Harness": 115, "Requires Unpromoted Node Surface": 2100, "Requires Wpt Harness": 22, "Rust Watchpoint Expected Failure": 22, "Support Fixture Not Top Level Test": 20, "Upstream Known Issue Or Platform Boundary": 26}` |
| `node24` | `tests/runtime/node/classifications/node24.json` | 2792 | 48 | 2840 | `{"Expected failure": 5, "Known gap": 2787, "Skipped / excluded": 48}` | `{"Requires Native Addon Harness": 31, "Requires Pseudo Tty Host Harness": 32, "Requires Pummel Stress Harness": 64, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 2495, "Requires Wpt Harness": 23, "Rust Watchpoint Expected Failure": 5, "Support Fixture Not Top Level Test": 47, "Upstream Known Issue Or Platform Boundary": 24}` |
