...
| `node22` | `supported` | `v22.22.3` | 4748 | 2350 | 2378 | 20 | 2398 | 4748 | 0 | 49.5% |
...
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6655 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `node22` | `tests/runtime/node/classifications/node22.json` | 2378 | 20 | 2398 | `{"Expected failure": 22, "Known gap": 2356, "Skipped / excluded": 20}` | `{"Requires Native Addon Harness": 29, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 55, "Requires Sequential Host State Harness": 115, "Requires Unpromoted Node Surface": 2078, "Requires Wpt Harness": 22, "Rust Watchpoint Expected Failure": 22, "Support Fixture Not Top Level Test": 20, "Upstream Known Issue Or Platform Boundary": 26}` |
