...
| `node26` | `current` | `v26.2.0` | 5578 | 1515 | 4017 | 46 | 4063 | 5578 | 0 | 27.2% |

## Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? | Notes |
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7195 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 144 catalog_entry_count | - | - | no | Ignored Rust watchpoints and expectation catalog entries used to preserve known failures and unexpected-pass diagnostics. |
...
| `node26` | `tests/runtime/node/classifications/node26.json` | 4017 | 46 | 4063 | `{"Expected failure": 34, "Known gap": 3983, "Skipped / excluded": 46}` | `{"Node26 Current Broad Pre Run Residual": 34, "Requires Native Addon Harness": 33, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 65, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 3687, "Requires Wpt Harness": 25, "Support Fixture Not Top Level Test": 46, "Upstream Known Issue Or Platform Boundary": 23}` |
...
- ignored Rust node_compat tests: 144
...
- entries: 144
- by expectation: `{"Expected failure": 144}`
- by classification: `{"Watchpoint": 144}`
- unexpected passes: 0
