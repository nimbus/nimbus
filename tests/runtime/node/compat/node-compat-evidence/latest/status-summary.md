...
| `node26` | `current` | `v26.2.0` | 5578 | 2087 | 3437 | 54 | 3491 | 5578 | 0 | 37.4% |

## Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? | Notes |
| --- | --- | ---: | ---: | ---: | --- | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7767 | - | yes | Byte-identical Node upstream test-* fixtures under lane-local nodeNN/test roots; pass percentages use only this denominator. |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 154 catalog_entry_count | - | - | no | Ignored Rust watchpoints and expectation catalog entries used to preserve known failures and unexpected-pass diagnostics. |
...
| `node26` | `tests/runtime/node/classifications/node26.json` | 3437 | 54 | 3491 | `{"Expected failure": 1, "Known gap": 3436, "Skipped / excluded": 54}` | `{"Requires Native Addon Harness": 38, "Requires Pseudo Tty Host Harness": 32, "Requires Pummel Stress Harness": 65, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 3135, "Requires Wpt Harness": 25, "Rust Watchpoint Expected Failure": 1, "Support Fixture Not Top Level Test": 46, "Upstream Known Issue Or Platform Boundary": 30}` |
...
| `streams-and-local-io` | 311 | 317 | 308 | 292 |

## Rust Ignored Test Inventory

- ignored Rust node_compat tests: 154
...
- entries: 154
- by expectation: `{"Expected failure": 154}`
- by classification: `{"Watchpoint": 154}`
- unexpected passes: 0
