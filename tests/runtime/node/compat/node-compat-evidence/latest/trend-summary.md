...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `node20` | `v20.20.2` | 917 | +1 | 21.6% | +0.0 | 0 | +0 |
| `node22` | `v22.22.3` | 2298 | +1 | 48.4% | +0.0 | 0 | +0 |
| `node24` | `v24.16.0` | 2328 | +1 | 44.8% | +0.0 | 0 | +0 |
| `node26` | `v26.2.0` | 1009 | +1 | 18.1% | +0.0 | 0 | +0 |
...
| `expectation_catalog_entry_count` | 135 | 135 | +0 |
| `oracle_report_count` | 0 | 0 | +0 |
| `required_canary_gap_count` | 0 | 0 | +0 |
| `rust_ignore_count` | 135 | 135 | +0 |
