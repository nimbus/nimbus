...
| `node26` | `v26.2.0` | `current` | 1163 | 4369 | 46 | 4415 | 5578 | 5578 | 0 | 20.8% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6843 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 137 catalog_entry_count | - | - | no |
