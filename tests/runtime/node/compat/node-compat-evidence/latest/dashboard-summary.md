...
| `node26` | `v26.2.0` | `current` | 1998 | 3528 | 52 | 3580 | 5578 | 5578 | 0 | 35.8% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7678 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 151 catalog_entry_count | - | - | no |
