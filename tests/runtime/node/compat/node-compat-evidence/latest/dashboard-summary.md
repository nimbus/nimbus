...
| `node26` | `v26.2.0` | `current` | 1416 | 4116 | 46 | 4162 | 5578 | 5578 | 0 | 25.4% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7096 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 141 catalog_entry_count | - | - | no |
