...
| `node26` | `v26.2.0` | `current` | 1118 | 4414 | 46 | 4460 | 5578 | 5578 | 0 | 20.0% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6798 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 136 catalog_entry_count | - | - | no |
