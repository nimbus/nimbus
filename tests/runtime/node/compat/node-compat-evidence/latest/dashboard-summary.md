...
| `node26` | `v26.2.0` | `current` | 1236 | 4296 | 46 | 4342 | 5578 | 5578 | 0 | 22.2% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 6916 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 138 catalog_entry_count | - | - | no |
