...
| `node26` | `v26.2.0` | `current` | 1455 | 4077 | 46 | 4123 | 5578 | 5578 | 0 | 26.1% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7135 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 142 catalog_entry_count | - | - | no |
