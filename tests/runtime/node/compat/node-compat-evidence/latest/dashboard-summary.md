...
| `node26` | `v26.2.0` | `current` | 1344 | 4188 | 46 | 4234 | 5578 | 5578 | 0 | 24.1% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7024 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 140 catalog_entry_count | - | - | no |
