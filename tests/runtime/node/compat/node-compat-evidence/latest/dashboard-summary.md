...
| `node26` | `v26.2.0` | `current` | 1862 | 3670 | 46 | 3716 | 5578 | 5578 | 0 | 33.4% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7542 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 149 catalog_entry_count | - | - | no |
