...
| `node26` | `v26.2.0` | `current` | 1515 | 4017 | 46 | 4063 | 5578 | 5578 | 0 | 27.2% |

### Evidence Tiers

| Tier | Source | Primary count | Passed | Claims | Official denominator? |
| --- | --- | ---: | ---: | ---: | --- |
| `official` | `vendored_official_fixture_corpus` | 19772 fixture_count | 7195 | - | yes |
...
| `watchpoint` | `tests/runtime/node/expectations/rust-watchpoints.json` | 144 catalog_entry_count | - | - | no |
