...
- generated at: `2026-08-29T01:38:19.644090+00:00`
...
| --- | --- | --- | --- | --- | --- | --- |
| `express` | Application | Node20 | `4.22.2` | Support | Supported | Passed |
| `fastify` | Application | Node20 | `5.12.1` | Support | Supported | Passed |
...
| `axios` | Application | Node22 | `1.20.0` | Support | Supported | Passed |
...
| `express` | Application | Node22 | `4.22.2` | Support | Supported | Passed |
| `fastify` | Application | Node22 | `5.12.1` | Support | Supported | Passed |
| `node:child_process` | Application | Node22 | `builtin` | Diagnostic | Service/microVM required | Passed |
| `esbuild` | Application | Node22 | `0.28.2` | Diagnostic | Service/microVM required | Passed |
...
| `sharp` | Application | Node22 | `0.35.4` | Diagnostic | Service/microVM required | Passed |
...
| `nanoid` | Application | Node22 | `5.1.16` | Support | Supported | Passed |
...
| `socket.io` | Application | Node22 | `4.8.3` | Support | Supported | Passed |
| `stripe` | Application | Node22 | `22.2.0` | Support | Supported | Passed |
| `undici` | Application | Node22 | `6.28.0` | Support | Supported | Passed |
...
| `axios` | Application | Node24 | `1.20.0` | Support | Supported | Passed |
...
| `express` | Application | Node24 | `4.22.2` | Support | Supported | Passed |
| `fastify` | Application | Node24 | `5.12.1` | Support | Supported | Passed |
| `node:child_process` | Application | Node24 | `builtin` | Diagnostic | Service/microVM required | Passed |
| `esbuild` | Application | Node24 | `0.28.2` | Diagnostic | Service/microVM required | Passed |
...
| `sharp` | Application | Node24 | `0.35.4` | Diagnostic | Service/microVM required | Passed |
...
| `nanoid` | Application | Node24 | `5.1.16` | Support | Supported | Passed |
...
| `socket.io` | Application | Node24 | `4.8.3` | Support | Supported | Passed |
| `stripe` | Application | Node24 | `22.2.0` | Support | Supported | Passed |
| `undici` | Application | Node24 | `6.28.0` | Support | Supported | Passed |
...
| `esbuild` | Application | Node26 | `0.28.2` | Diagnostic | Service/microVM required | Passed |
...
| `sharp` | Application | Node26 | `0.35.4` | Diagnostic | Service/microVM required | Passed |
...
| `nanoid` | Application | Node26 | `5.1.16` | Support | Supported | Passed |
...
| `next` | Tooling | Node22 | `16.3.3` | Support | Supported | Passed |
| `prisma` | Tooling | Node22 | `7.10.0` | Support | Supported | Passed |
...
| `next` | Tooling | Node24 | `16.3.3` | Support | Supported | Passed |
| `prisma` | Tooling | Node24 | `7.10.0` | Support | Supported | Passed |
...
| Node26 | `test/parallel/test-buffer-alloc.js` | Passed | Passed | Agreement Pass | `v26.7.0` |
