...
| Node24 | Product default; Active LTS | `v24.21.0` | [Compatibility](compatibility.md) |
| Node26 | Current/non-LTS compatibility target | `v26.10.0` | [Compatibility](compatibility.md) |
