...
| Node24 | Supported In Process | Active LTS | yes | yes | `v24.21.0` | lane-local LTS evidence |
| Node26 | Supported In Process | Current non-LTS | no | no | `v26.10.0` | Current non-LTS; promote to LTS support only after LTS and lane-local evidence |
