# NDS gate - FORMAL documented blocked state (cycle-46, 2026-06-13)
...
Step 9 needs both lanes `gaps==0` AND `pass_rate==100`. Current generated posture: **node22 = 55**, **node24 = 63**. Not 0/0.

Session cycles 17-46 reduced the gate 81/87 -> 55/63 by harvesting every cheap/clean/
...
listener/client reclassification for a stream-base socket fixture; all
dynamically green-guarded or structurally source-confirmed, zero false greens,
regression-verified at their promotion surface). 65 unique fixtures remain
(node22=55, node24=63).
...
multi-session effort. Gate held RED and honest at node22=55 / node24=63.
