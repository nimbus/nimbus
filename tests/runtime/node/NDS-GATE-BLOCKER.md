# NDS gate - FORMAL documented blocked state (cycle-36, 2026-06-13)
...
Step 9 needs both lanes `gaps==0` AND `pass_rate==100`. Current generated posture: **node22 = 63**, **node24 = 73**. Not 0/0.

Session cycles 17-36 reduced the gate 81/87 -> 63/73 by harvesting every cheap/clean/
...
uncaughtException stack handling; all
dynamically green-guarded or structurally source-confirmed, zero false greens,
regression-verified). 75 unique fixtures remain (node22=63, node24=73).
...
### DEEP_behavioral_misc (6) - owner: nimbus/deno (per-fixture deno_node/deno_core)
...
multi-session effort. Gate held RED and honest at node22=63 / node24=73.
