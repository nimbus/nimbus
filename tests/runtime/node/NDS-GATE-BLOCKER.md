# NDS gate - FORMAL documented blocked state (cycle-35, 2026-06-13)
...
Step 9 needs both lanes `gaps==0` AND `pass_rate==100`. Current generated posture: **node22 = 64**, **node24 = 74**. Not 0/0.

Session cycles 17-35 reduced the gate 81/87 -> 64/74 by harvesting every cheap/clean/
...
Error.prepareStackTrace plus source-map self-exec parity; all
dynamically green-guarded or structurally source-confirmed, zero false greens,
regression-verified). 76 unique fixtures remain (node22=64, node24=74).
...
### DEEP_behavioral_misc (7) - owner: nimbus/deno (per-fixture deno_node/deno_core)
...
multi-session effort. Gate held RED and honest at node22=64 / node24=74.
