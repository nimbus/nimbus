...
**Current gate (already done): node22 = 21, node24 = 27.** Session cycles 17-75
took it from 81/87 -> 21/27 (published fork tags, reclassifications, promotions,
...
| Nimbus Deno fork | `/Users/jack/src/github.com/nimbus/deno`, branch `nimbus/v2.8.3`, currently tag `v2.8.3-nimbus.24` |
...
- **28 unique required fixtures remain, with 5 genuinely blocked and the rest
  ...
  esm-loader (deno_core), promise-hooks (deno_core), and the remaining
  WebStreams unref hang-timeout surface.
- **Suggested order:** crypto primitive feasibility/probes, then ESM loader, then
  promise-hooks / WebStreams hang-timeout cleanup. Cycle71 promoted the Node24
