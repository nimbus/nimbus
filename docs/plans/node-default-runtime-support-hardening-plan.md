...
| `node24` | default | `v24.16.0` | 276 / 5198 | 4872 | 50 | 5.3% |
...
| 2026-06-01 | NDS3 | in_progress | `Cargo.toml`, `Cargo.lock`, `crates/nimbus-runtime/src/runtime/bootstrap/js/node22_runtime_bootstrap.js`, `crates/nimbus-runtime/src/runtime/tests/node/cases/watchpoints_core.rs`, `crates/nimbus-runtime/src/runtime/tests/node/cases/watchpoints_extended.rs`, `scripts/runtime/node/classifications.py`, `scripts/runtime/node/status.py`, generated Node compatibility evidence/docs, `docs/plans/proof/node-default-runtime-support-hardening/nds3-official-fixture-promotion.md` | Broad pre-run `cargo test -p nimbus-runtime node24_default_lane_ -- --ignored --nocapture --test-threads=1`; focused console/events/URL/dotenv tests pass; promoted broad rerun `node24_default_lane_executes_core_semantics_subset` -> `122 passed, 1 skipped, 0 failed`; process/timing partial rerun -> `46 passed, 0 skipped, 2 failed`; `bash scripts/verify-node-default-runtime-support-hardening.sh` -> `15 passed, 19 failed` | Corrected pass accounting from source-topology to execution-only evidence; promoted Node24 core-semantics from ignored red watchpoint to regular green coverage; Deno fork tags `v2.8.0-nimbus.10` and `v2.8.0-nimbus.11` landed and Nimbus is repinned to `.11`; current Node24 posture is `276 / 5198` with estimated reachable ceiling `2480`. |
