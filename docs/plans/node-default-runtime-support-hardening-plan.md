...
| Current row | `NDS3` |
| Latest verifier output | `15 passed, 19 failed (NDS3 in progress; current-row and future-row gates failing as expected)` |
...
| 2026-06-01 | NDS3 | in_progress | `Cargo.toml`, `Cargo.lock`, `crates/nimbus-runtime/src/runtime/bootstrap/js/node22_runtime_bootstrap.js`, `crates/nimbus-runtime/src/runtime/bootstrap/js/perf_hooks.js`, `crates/nimbus-runtime/src/runtime/tests/node/cases/watchpoints_core.rs`, `crates/nimbus-runtime/src/runtime/tests/node/cases/watchpoints_extended.rs`, `crates/nimbus-runtime/src/runtime/tests/node_compat_manifests/fixtures/process-and-timing.json`, `crates/nimbus-runtime/src/runtime/tests/node/manifest_topology.rs`, `scripts/runtime/node/classifications.py`, `scripts/runtime/node/status.py`, generated Node compatibility evidence/docs, `docs/plans/proof/node-default-runtime-support-hardening/nds3-official-fixture-promotion.md` | Broad pre-run `cargo test -p nimbus-runtime node24_default_lane_ -- --ignored --nocapture --test-threads=1`; focused console/events/URL/dotenv/util/perf-hooks tests pass; promoted broad rerun `node24_default_lane_executes_core_semantics_subset` -> `122 passed, 1 skipped, 0 failed`; promoted broad rerun `node24_default_lane_executes_process_and_timing_subset` -> `48 passed, 0 skipped, 0 failed`; `bash scripts/verify-node-default-runtime-support-hardening.sh` -> `15 passed, 19 failed` | Corrected pass accounting from source-topology to execution-only evidence; promoted Node24 core-semantics and process/timing from ignored red watchpoints to regular green coverage; Deno fork tags `v2.8.0-nimbus.10`, `.11`, and `.12` landed and Nimbus is repinned to `.12`; current Node24 posture is `323 / 5198` with estimated reachable ceiling `2480`. |
