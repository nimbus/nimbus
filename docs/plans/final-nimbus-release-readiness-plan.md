...
alignment has been classified, full Nimbus verification passes, the published
GitHub release artifacts can be downloaded and re-verified, and the matching
Nimbus OCI image is published to GHCR with digest, signature, provenance, SBOM,
