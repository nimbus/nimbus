...
- **`docs/plans/node-lts-compatibility-execution-log.md`** owns the full
...
Full chronological history lives in `docs/plans/node-lts-compatibility-execution-log.md`. Update that companion log and the roadmap status in this plan before stopping.
