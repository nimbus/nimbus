...
- `nimbus/nimbus-libkrun` release `v1.18.1-nimbus.1` implements
...
|-----------|----------|---------------|-------|---------|
| crun | containers/crun | 1.27.1 | `nimbus/nimbus-crun` tag `v1.27.1-nimbus.2` | Read and validate `krun.port_map`, call legacy `krun_set_port_map()` for legacy entries, and fail closed for address-bearing entries unless libkrun has the bind-address hook |
| libkrun | containers/libkrun | 1.18.1 | `nimbus/nimbus-libkrun` tag `v1.18.1-nimbus.1` | Add `krun_set_port_map_with_bind_address()` and bind TSI listeners to requested host addresses |
