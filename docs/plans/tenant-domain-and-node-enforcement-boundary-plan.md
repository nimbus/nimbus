...
- `crates/nimbus-server/src/tenant_isolation.rs` is now a thin re-export root.
  Tenant-isolation implementation lives in concept-owned children such as
