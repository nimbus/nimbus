...
supported `docs/plans/archive/node-lts-compatibility-plan.md` during NLC and now serves
...
- **Historical parent owner:** `docs/plans/archive/node-lts-compatibility-plan.md`
- **Completed successor baseline:** `docs/plans/archive/node-compat-future-lanes-and-correctness-plan.md`
...
`docs/plans/archive/node-lts-compatibility-plan.md`, not a competing roadmap.
...
- Replacing `docs/plans/archive/node-lts-compatibility-plan.md` as the broad Node
  compatibility owner.
...
12. The global runtime-suite serialization lock remains intact unless a later
    ...
    it.
13. `docs/plans/archive/node-lts-compatibility-plan.md`,
    `docs/plans/archive/node-compat-test-infrastructure-plan.md`, and
    `docs/plans/archive/node-compat-future-lanes-and-correctness-plan.md` now all
