...
`docs/plans/external-sql-storage-backends-plan.md` after the Postgres-first
...
- **Activation source:** promoted from `PX7` in
  `docs/plans/external-sql-storage-backends-plan.md` on 2026-04-09
