...
| NDB1 | 1395381b | wire zbus_systemd workspace dep behind systemd-dbus feature |
| NDB2 | f76483d3 | ZbusSystemdClient skeleton with bus selection + capability probe |
| NDB3 | a07922e4 | signal-correlated job completion via Manager.Subscribe + JobRemoved |
| NDB4 | c9498129 | zbus error taxonomy → nimbus_core::Error mapping |
