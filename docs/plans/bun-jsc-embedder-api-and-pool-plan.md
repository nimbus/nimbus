...
- Every invocation carries backend kind, trust tier, lockdown profile,
  ...
  context.
- Cancellation and teardown are pool-owned and verified on macOS and Linux.
