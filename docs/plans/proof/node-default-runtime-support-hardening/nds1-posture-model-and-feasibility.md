...
- **NDS3 accounting amendment (2026-06-01).** During NDS3, the status generator
  ...
  Node26 `0 / 5578`. After promoting the Node24 `core-semantics` and
  `process-and-timing` broad groups, the generated posture reports Node24
  `323 / 5198`, required gaps `1730`, optional promotable gaps `427`, and an
  estimated reachable ceiling of `2480`. The `2000` target remains reachable on
  paper but still requires substantial NDS3 implementation work.
