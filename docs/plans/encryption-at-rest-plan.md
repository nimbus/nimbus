...
| EAR4 | in_progress | Establish the shared local-SQLite encrypted-open seam and implement encrypted embedded SQLite via SQLCipher, including release-matrix and packaging proof | EAR1, EAR2 |
