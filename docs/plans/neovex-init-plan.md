...
- **Plan status:** `done`
- **Control item:** Phase 1 complete (I1–I8 all `done`)
...
| P7: CLI reference | `done` | I8 | `docs/operating/cli.md` updated with `neovex init` and auto-init behavior |
...
| Item | Status | Hard deps | Completion gate |
|------|--------|-----------|-----------------| 
| I8: Update `docs/operating/cli.md` | `done` | I5, I6 | `neovex init` command documented with flags, defaults, and examples. `neovex dev` section updated to describe auto-init scaffold behavior and auto-tenant. Dev command taxonomy entry updated. |
...
| 2026-04-27 | I8 | `done` | `docs/operating/cli.md` updated: added `neovex init` to CLI shape, command taxonomy, and new Init Command section with flags, defaults, and examples. Updated Dev Command section to describe auto-scaffold and auto-tenant behavior. | Docs-only change, no Rust verification needed |
