...
- **Active item:** D0.6 (control plane: Create/Describe/Delete/List/UpdateTable) — handlers + dispatch auth/routing done; remaining piece is the official-SDK end-to-end control-plane proof (parity runner). D0.0a, D0.0, D0.1, D0.1b, D0.2, D0.3, D0.4, D0.5, D0.8 are `done`.
