...
- **Active item:** D7.3 (Nimbus-native access-key management). **All of D0, D1, D2, D3, D4, D5 (T5 Streams), D6 (T6 TTL + Tagging), and D7.1–D7.2 (SigV4 strict verification + rejection paths) are `done`** — the full T0–T6 operation surface is implemented and SDK-proven, and strict SigV4 is enforced when enabled.
