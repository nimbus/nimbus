...
- **Active item:** D1 (T1 single-item data plane: PutItem/GetItem/DeleteItem/UpdateItem). **All of D0 is `done`** (D0.0a, D0.0, D0.1, D0.1b, D0.2, D0.3, D0.4, D0.5, D0.6, D0.7, D0.8, D0.9).
