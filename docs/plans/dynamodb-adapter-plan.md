...
- **Active item:** D7.1 (SigV4 strict verification — first T7 item). **All of D0, D1, D2, D3, D4, D5 (T5 Streams), and D6 (T6 TTL + Tagging) are `done`** — the full T0–T6 operation surface is implemented and SDK-proven.
