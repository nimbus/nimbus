...
Status: `cleanup in progress` | Owner: this plan | Created: 2026-08-17.
...
Next action: run the AVR12 cleanup gates, open the cleanup pull request, record
its number, and freeze the complete archive candidate.
