...
`docs/plans/archive/node-lts-compatibility-plan.md` and the completed harness baseline
in `docs/plans/archive/node-compat-test-infrastructure-plan.md`.
...
Separate future-lane metadata into explicit upstream lifecycle, Nimbus lane
