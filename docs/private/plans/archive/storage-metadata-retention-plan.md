...
Status: `complete` | Owner: archived; remaining Band SA work stays in `architecture-review-2026-07-plan.md` | Created: 2026-08-25 | Completed: 2026-08-26 | PRs: #313–#321.
Baseline: main @ cc7ae36a3c21bf7aa093c013f3025d074c679438.
Proof root: `docs/private/plans/proof/storage-metadata-retention/`.
Next action: none. This plan is archived. Resume remaining Band SA work from
`docs/private/plans/architecture-review-2026-07-plan.md`.
...
| SMR9 | After the final code pull request merges, archive this plan, retain its proof root, remove its active index entry, and close Band SA row SA4 with exact evidence. | `done` | Archived as `archive/storage-metadata-retention-plan.md`; proof root retained; active index entry removed; SA4 closed with verifier 18/0, PRs #313–#321, and `SAFE` proof. Remaining Band SA work routes through the architecture-review plan. |
...
| 2026-08-26 | SMR3 | completed | PR #319 merged as `820549575`. The bounded shipped profile, explicit retain-all mode, one controller per loaded tenant, off-route preparation, ordered finalization, lifecycle drainage, manual trigger, diagnostics, metrics, configuration surfaces, late-pin guard, and recovered-retry regression satisfy SMR3. Verifier advanced from 13/5 to 16/2; final Nimbus autoreview was clean. |
...
| 2026-08-26 | SMR9 | completed | Archived the complete plan after PRs #313–#321, retained `proof/storage-metadata-retention/`, removed the active plan route, and closed Band SA row SA4 with the 18/0 verifier and measured `SAFE` verdict. `architecture-review-2026-07-plan.md` owns all remaining Band SA work. |
