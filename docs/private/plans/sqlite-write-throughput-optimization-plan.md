...
| SWT1 Prepared statements + batch-invariant apply context | `in_progress` | `codex/sqlite-write-throughput-p1-batch-sql` / `nimbus-sqlite-write-throughput-p1` | local `7fc79dbea`+`9a6d7b744`; PR pending | N=256 paired +54.1% [CI +47.3,+61.0], candidate ~45,048 abs; N=32 +19.9%; storage lane +110.7%; N=1 −3.79% (in gate); hot-key N=32 −5.46% (accepted deviation, D15) | 428/428 storage; 253/253 Engine journal/publisher/direct/unit/fanout; fail-before RED/GREEN for both tasks; invalidation tests | `proof/sqlite-write-throughput/swt1/ab-acceptance.md` | orchestrator review/push/PR/merge |
...
| SWT1 | `9a6d7b744` | 1,943 (n1 micro mean) | 20,251 | 45,048 | valid-pair CVs ≤6.5% / paired CI [+47.3,+61.0] | 2,996 (−5.46% deviation, D15) | 91,324 layered pair | not re-measured (SWT2) | layered fixture byte shape unchanged | accepted with D15 deviation |
| SWT2 | — | — | — | — | — | — | — | — | — | pending |
...
| D15 | 2026-07-28 | Accept SWT1 with a documented hot-key deviation (owner decision) | Hot-key N=32 paired −5.46% [CI −6.0,−4.9] vs the ≤5% gate: an OCC retry-equilibrium shift caused by ~2× faster apply turnaround, not hidden per-op overhead; N=256 +54.1% and storage +110.7%; retry-policy tuning is Engine-owned follow-up territory and SWT2 re-measures every lane |
