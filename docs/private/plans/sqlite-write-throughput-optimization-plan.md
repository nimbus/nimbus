...
| SWT2 Resident embedded writer connection | `in_progress` | `codex/sqlite-write-throughput-p2-writer-residency` / `nimbus-sqlite-write-throughput-p2` | local `7cf5266d7`; PR pending | Storage +39.8/+31.8% paired; N=1 +250.5% [CI over 5 pairs]; N=32 +97.8%; N=256 +14.6% (~44k abs); hot-key ≈+180% directional (no clean pair; D15 reversed); cold open +59.8µs in gate | residency/poison/encrypted/coexistence tests; 431/431 storage; 253/253 Engine groups | `proof/sqlite-write-throughput/swt2/ab-acceptance.md` | review/push/PR/merge |
...
| SWT2 | `7cf5266d7` | ~4,670 | 28,727 | 40,812–44,769 | valid pair +14.6%; all candidates > all bases | ≈5,900 directional (+180%) | 103,332 layered pair | not re-measured | byte shape unchanged | accepted; gates met on clean pairs |
