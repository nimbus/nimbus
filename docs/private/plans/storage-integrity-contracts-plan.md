...
Next action: SIC2 is implemented and verified on `codex/sic-sic2`. Pull request #284 is green on hosted CI, 53 checks pass and 0 fail, after the two shard flakes recorded as blocker B4 were re-run against the unchanged tree. Next is the merge of #284, then SIC3 cut from updated main.
