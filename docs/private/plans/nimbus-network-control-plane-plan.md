...
| Last checkpoint commit | NNC7.2 item commit `d031a1bdeee0e322fa822254668a1f971169067d` is the named predecessor; the NNC7.3 commit containing this row is the current durable checkpoint. |
...
| Latest dirty-state checkpoint | The NNC7.3 item commit left a clean worktree. NNC7.4 starts with a read-only audit before it names any product path. |
