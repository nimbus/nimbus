...
Status: `active; NNC6.5 complete; NNC6.5a acceptance green; commit pending`
...
| Field | Current value |
| --- | --- |
| Plan status | `active; NNC6.5 complete; NNC6.5a acceptance green; commit pending` |
| Current band | `NNC6 — compute orchestration and exact lifecycle order` |
| Current item | `NNC6.5a — strict portable teardown protocol and durable reducer` |
| Last completed item | `NNC6.5 — teardown choreography substitution audit` |
| Next action | Close the final proof and ledger, stage and hash the exact 32-path candidate, then create the one evidence-backed NNC6.5a item commit. |
| Current acceptance checkpoint | The sole full review accepted one P1 and four P2 defects. The sole narrow correction review accepted one P1 and two P2 defects. All eight are corrected. Narrow fail-before is exact `39/43`; corrected focused behavior is `44/44`. Final affected behavior is workloads `216/216`, compute `303` plus one ignore, and serialized server `602` plus 32 ignores. Roster `47/47`, strict quality, static seams, NNCV029 `24/24 + 10/10`, NNCV035 `55/55 + 0/11`, and aggregate `35/36` sole NNCV035 red pass. Review cadence is exhausted; no third review is permitted or warranted. |
...
| Last checkpoint commit | `c0b5e8b4f8f3c3176af6ecaf1c6a29ea396d9fca` is the clean NNC6.5 recovery checkpoint and exact NNC6.5a fail-before base. |
| Audit dirty state | NNC6.5a owns exactly `32` candidate paths: `28` Rust paths including eight new concept-owned modules, the canonical plan, routing index, ignored item proof, and one NNCV029 version-token verifier. No Cargo manifest, compute production source, provider adapter, caller cutover, or NNCV035 source changed. The original checkout remains untouched with its user-owned `AGENTS.md`, concurrent-write benchmark, and browser bundle changes. |
| Latest dirty-state checkpoint | The candidate is based on recovery commit `c0b5e8b4f8f3c3176af6ecaf1c6a29ea396d9fca`. The full-review input was tree `e111a0afaf227ec9114b11c96625c645e1651e50` across 29 paths. The narrow-review input was tree `cc87e8c38f6fceab558c863010b8f81df0b84de8` across 31 paths. The final 32-path tree and patch identities remain to be recorded after proof closeout. |
| Current item review | The sole full GPT-5.6 Sol/xhigh/fast review completed in thread `019fe5cb-75f5-7db3-aea3-5ec695cc3a22` at overall confidence `0.98`; its one P1 and four P2 findings are corrected. The one permitted narrow review used the same reviewer settings and reported one P1 and two P2 findings at overall confidence `0.98`; all three are corrected with exact fail-before and final regression proof. Review cadence is exhausted. Do not run a third review for these corrections or closeout docs. |
| Full-review input identity | Staged tree `e111a0afaf227ec9114b11c96625c645e1651e50`; complete patch SHA-256 `9be80c24246d423f0db418563bd8f9b9ab35ca736963cf281dd021315f81cb8c`; executable/script patch SHA-256 `42db215e43abf096a095aeb861c14886ce2f5a5edca1e9917b28c5feb25503fb`; 29 paths; reviewer thread `019fe5cb-75f5-7db3-aea3-5ec695cc3a22`; output `/tmp/nnc65a-autoreview.out` and `/tmp/nnc65a-autoreview.json`. |
| Narrow-review input identity | Staged tree `cc87e8c38f6fceab558c863010b8f81df0b84de8`; complete patch SHA-256 `0de7f439a37b87d8a5063b0ba46363351c475cb66490435132f9527a1f507cad`; executable/script patch SHA-256 `3f4b893c1cdf78e03254c1ec2a06e56b68077704b3b29d93e434520ad661a1b6`; 31 paths; output `/tmp/nnc65a-narrow-autoreview.out` and `/tmp/nnc65a-narrow-autoreview.json`. |
| Final closeout identity | Acceptance-green staged tree before identity-only ledger insertion: `9fb35e90d7f3fdcf09931dd822650dccd8c1c1d0`; complete patch SHA-256 `0d82c4566734884b09f610c35e2ea526669bf09895e221eb88ebe079857dbb86`; final executable/script patch SHA-256 `af284c1f7687c801a13aec5528fb3c03e9116828e828f1a54ef2edf7443fcb91`; 32 paths. The exact item commit remains pending. |
...
| Last verification | Final behavior passes workloads `216/216`, compute `303` plus one ignore, and serialized server `602` plus 32 ignores. Test discovery is exact `47/47`; narrow focused behavior is `44/44`. Strict affected-crate Clippy and warning-denied Rustdoc pass. Manifest, effect-token, direct-advance, dependency, and modularity scans pass. NNCV029 is `24/24` plus `10/10`; NNCV035 is `55/55` plus exact live `0/11`; aggregate is `35/36` with only NNCV035 red. Rustfmt, Bash syntax, scoped ShellCheck, diff, proof lint with zero diagnostics, docs `108`, and site `17/17` pass. |
| Latest verification checkpoint | `/tmp/nnc65a-narrow-fail-before.out`, `/tmp/nnc65a-narrow-correction-focused2.out`, `/tmp/nnc65a-narrow-final-workloads.out`, `/tmp/nnc65a-narrow-final-compute.out`, `/tmp/nnc65a-narrow-final-server.out`, `/tmp/nnc65a-narrow-final-clippy.out`, `/tmp/nnc65a-narrow-final-rustdoc.out`, `/tmp/nnc65a-narrow-final-test-roster-summary.out`, `/tmp/nnc65a-narrow-final-static.out`, `/tmp/nnc65a-narrow-final-nncv029.out`, `/tmp/nnc65a-narrow-final-nncv029-self-test.out`, `/tmp/nnc65a-narrow-final-nncv035-self-test.out`, `/tmp/nnc65a-narrow-final-nncv035-live.out`, `/tmp/nnc65a-narrow-final-aggregate-closeout.out`, `/tmp/nnc65a-narrow-final-proof-lint.out`, `/tmp/nnc65a-narrow-final-docs-check.out`, and `/tmp/nnc65a-narrow-final-docs-site.out`. |
| Blocking decision | No blocker. Review cadence is exhausted; close the proof and commit NNC6.5a. |
...
| NNC6.5b | Add the compute-owned teardown decision, confirmed-command gate, dispatcher, driver, exact capability registry, and explicit runtime. | Only a direct confirmed CAS winner can receive Execute; replay and ambiguous store/effect outcomes receive Inspect; five exact small capabilities have no fallback; contender, cancellation, CAS conflict, stale/crossed, and crash-after-claim/effect tests prove one effect and durable convergence. This item adds no provider implementation or product caller cutover. |
| NNC6.5c | Add exact final-ingress plus DirectProcess/Systemd drain/stop capability adapters. | Server final withdrawal cancels and joins the exact workers, closes routes, settles inherited listener authority, and returns exact absence; settlement failure blocks phase progress. DirectProcess and Systemd bind the confirmed command and expose separate drain/stop execute+inspect behavior. Crossed/stale commands make zero effects, and real substitution tests use both execution providers. |
| NNC6.5d | Add honest Container/Krun execution drain/stop and forwarded-machine detach/release capability adapters over existing provider journals. | Container durably records stop intent before TERM/KILL. Both backends prove distinct drain, stop, detach, and release boundaries and reuse the shared attachment state machine. Host-managed and machine-forwarded matrices cover exact replay, ambiguity, fresh-process crash cuts, parent/guest absence, PEP/listener/IPAM/segment fencing, and no premature reuse. No provider effect or duplicate journal enters `nimbus-network`. |
| NNC6.5e | Cut native service/sandbox stop and definition deletion over to the compute teardown runtime. | Service and sandbox stop persist withdrawal before effects and observe the full order. Services loses provider-stop authority, retains names/source/session policy and observed projection only, and exposes an exact source claim/finalize seam. Force deletion fences or settles in-flight provision/restart, drains a late success, keeps source/sessions until safe terminal progression, and unresolved persistence makes zero stop effects. |
| NNC6.5f | Cut Compose, guest, forwarded-machine, and physical-machine boundaries over to exact compute teardown. | Local and forwarded Compose down open the canonical Engine store, never create a CLI-local journal, and return durable idempotent outcomes. Exact machine phase envelopes bind every fence; parent publication withdraws before guest stop and releases after exact guest/provider absence. Physical machine stop either uses the canonical workload drain or returns a typed conflict while active durable workload authority exists. |
...
| NNC6 — compute choreography | `in_progress` | Exact provision/teardown observers across every workload/retirement path. | NNC6.1-NNC6.5 and NNC6.1e1 are complete. NNC6.5a is candidate-frozen with all pre-review gates green. NNC6.5b-NNC6.5g are the frozen implementation/review units that follow it. No completed item retains a temporary legacy authority. NNC6.6 retains resolver fencing; NNC6.1e2 is the final convergence gate. Provider effects remain with their named owners. |
...
| NNC6.5a | `in_progress` | **Dependency:** NNC6.5 complete at `94b52356ec79ae678f970911c3f82efec44f46b0`. **Evidence:** `docs/private/plans/proof/nimbus-network-control-plane/nnc6.5a-strict-portable-teardown-protocol.md`. **Candidate state:** the full review's one P1/four P2 and narrow review's one P1/two P2 are all corrected. Narrow fail-before is `39/43`; focused correction is `44/44`; final behavior is `216 + 303 + 602`, with one compute and 32 server ignores. Roster `47/47`, quality/seams, NNCV029 `24/24 + 10/10`, NNCV035 `55/55 + 0/11`, and aggregate `35/36` sole NNCV035 red pass. Review cadence is exhausted. **Owned value:** one strict workloads protocol/reducer, exact provision/restart handoffs, strict server persistence, and mechanical test-fixture replacement. **Owned paths:** 32 candidate paths: 28 Rust, plan, routing index, proof, and NNCV029 verifier. **Last green:** final affected behavior, exact roster, quality/seams, and verifier matrix. **Next:** close proof/docs, stage and hash the exact item, then commit. **Forbidden:** provider effects, compute production behavior, caller cutover, compatibility paths, and new network edges. **Blocker:** none. |
| NNC6.5b | `todo` | **Dependency:** NNC6.5a. Compute confirmed-command/driver/registry only; no provider implementation. |
| NNC6.5c | `todo` | **Dependency:** NNC6.5b. Server ingress and DirectProcess/Systemd adapters. |
| NNC6.5d | `todo` | **Dependency:** NNC6.5b. Container/Krun drain/stop and host-managed/forwarded-machine detach/release adapters. |
| NNC6.5e | `todo` | **Dependency:** NNC6.5c and NNC6.5d. Native service/sandbox/definition caller cutover. |
| NNC6.5f | `todo` | **Dependency:** NNC6.5c and NNC6.5d. Compose, guest, forwarded, and physical-machine boundary cutover. |
