...
Status: `active; NNC4.6e complete; NNC4.6f in progress`
...
| Field | Current value |
| --- | --- |
| Plan status | `active; NNC4.6e complete; NNC4.6f in progress` |
| Current band | `NNC4 — evidence-based capability registry and sovereignty profile` |
| Current item | `NNC4.6f — close the production manager/root/primitive-handle census and verifier` |
| Last completed item | `NNC4.6e — separate parent-host and guest-node machine network authority` |
| Next action | Commit the exact NNC4.6e Nimbus checkpoint, then continue NNC4.6f with its read-only constructor/root/primitive-handle substitution audit; no NNC4.6f implementation path is dirty yet. |
| Current acceptance checkpoint | NNC4.6e Bands A-D and E1-E17 are green. Its sole full item review produced nine accepted findings; the one permitted narrow correction review then produced two accepted P1 findings. All eleven are corrected and reverified. Exact process-birth evidence now prevents a recycled PID from authorizing a signal or false provider absence, and strict start/stop DTOs reject duplicate binding evidence. Final aggregates pass at network 221/0/0, machine 27/0/0, sandbox 736/0/24, CLI 932/0/1, server 601/0/28 under the recorded inherited exclusions, and assets 9/0/0. Affected check, workspace strict Clippy, warning-denied rustdoc, the 62-authority/36-risk/five-local-IPC census, composition census, live verifier 16/16, self-test 51/51, and all six `machine-os` lanes pass. |
...
| Last checkpoint commit | `8468ddce3b5afc001356ea2a3ee099d29781957c` — NNC4.6g. |
| Audit dirty state | The exact NNC4.6e Nimbus item is candidate-frozen for its containing commit. Its source set owns machine authority/DTO vocabulary, atomic exact-plan port batches, preselected sandbox identity, retained host authority, durable parent publication intent, authenticated parent/guest receipts, exact gvproxy process-birth evidence, provenance and monotonic generations, guest-manager-first composition, strict boot evidence, disabled-by-default direct Machine API startup, and whole-machine withdraw/release/restart/delete reconciliation. The isolated `machine-os` companion is clean at commit `f0cf9eca2878eb07bd24eec6562fcc58b40f0b5e`; neither original source checkout nor unrelated state was modified. |
| Latest dirty-state checkpoint | Starting Nimbus HEAD `8468ddce3b5afc001356ea2a3ee099d29781957c`, tree `0964dc7343bddb745dd7b356233b99c582a524c1`. Final Nimbus executable SHA-256 `44099ca802550b3587b934b835a6372b901ccdaa3990e8b4b4c76a13edde7a47`; companion `machine-os` executable SHA-256 `9e391aa6985c343f43d9c22029747d7fcca2582f2ca04c644d5eb330a7210533`, commit `f0cf9eca2878eb07bd24eec6562fcc58b40f0b5e`, tree `b32015ba67b7802784ada0b308b4c28fbdbaedad`. Both branches remain unpushed with no PR. |
| Current item review | The sole full GPT-5.6 Sol/xhigh/fast item review ran through helper threads `019faf82-4d02-7ee2-8de0-b87403298857` and `019faf88-5d10-7431-aedc-7a325879d7bc` over combined executable SHA-256 `97cfb2c16d509c4986ded83f36653dea0bb237b59aaa6f539e7349a7ee6caf8d`; its nine findings were accepted and corrected. The one permitted narrow correction review ran through `019fafcb-aa4e-7840-9b96-b3cf086dc4bb` and `019fafcf-65a6-7242-8f3c-e6e9a12ca084` over combined SHA-256 `f2ce2650b7e31b696b981ba5dbdeddb937afed29adc2dbbdd8742ee3994b310f`; both P1 findings were accepted, corrected, and reverified. No further NNC4.6e review is warranted. |
...
| Last verification | Final NNC4.6d network/operator 243/0, sandbox 722/24, CLI 895/1, server 601/28 under two exact inherited exclusions, affected check, strict Clippy, warning-denied rustdoc, format/diff, exact core-only edge and composition/bind census, verifier 16/16, self-test 51/51, docs 108 pages, and site 17/17 pass. |
| Latest verification checkpoint | Final aggregates pass: `nimbus-network` 221/0/0, `nimbus-machine` 27/0/0, `nimbus-sandbox` 736/0/24, `nimbus-cli` 932/0/1, `nimbus-server` 601/0/28 with the recorded inherited-baseline names filtered after clean-checkpoint reproduction, and `nimbus-assets` 9/0/0. Six-crate all-target/all-feature check, workspace `make clippy`, six-crate warning-denied rustdoc, format/diff, exact core-only edge, 62-authority/36-risk/five-local-IPC bind census, composition census, live verifier 16/16, verifier self-test 51/51, and six deterministic `machine-os` lanes pass. |
| Blocking decision | No blocker. NNC4.6e is acceptance-complete and candidate-frozen for its exact containing commit; NNC4.6f is next. |
...
| NNC4 — capabilities/sovereignty | `in_progress` | Named negative matrix, evidence-based seams, machine modes, offline local profile. | NNC4.1-NNC4.6e plus NNC4.6g are complete. NNC4.6f is in progress and owns constructor/root/primitive-handle census closure. NNC4.7 remains the sovereignty tripwire owner. |
...
| NNC4.6f | `in_progress` | **Dependency:** NNC4.6b-e plus NNC4.6g are complete. **Owned paths:** none dirty; this row is the explicit post-NNC4.6e recovery handoff. **Last green:** NNC4.6e final proof records network 221, machine 27, sandbox 736/24, CLI 932/1, server 601/28, assets 9, affected check/Clippy/rustdoc, verifier 16/16 plus self-test 51/51, docs 108, and site 17/17. **Next:** read the NNC4.6f band and existing bind/composition census, then inventory every production manager constructor, root resolver, and primitive-handle reconstruction before adding fail-before verifier cases or editing implementation. **Acceptance:** the machine-readable census classifies every production occurrence as owning manager, manager-derived handle, admitted cross-process reconstruction, or test fixture; no unclassified raw root remains; the verifier self-tests every named escape while preserving the exact core-only edge. **Blocker:** none. |
| NNC4.7 | `todo` | — |
| NNC5.1 | `todo` | — |
| NNC5.2 | `todo` | — |
| NNC5.2a | `todo` | — |
