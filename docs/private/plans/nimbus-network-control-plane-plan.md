...
| Last checkpoint commit | `99930529633e02f027ae17adaa8d7379a73af37b` is the durable R3 service/SDK checkpoint. Its tree is `af4a97170092e2b145b622b78bf62ddc544c4a9e`; its patch from the prior recovery commit is SHA-256 `587962a6ce7d8d146cc3a3b94fe2c4292c44c5a0a8c65a366198945d54035c2c` across `25` owned paths. R3 verifier extraction remains durable at `e1c57ce9eba823b8dc7d0a5a4ab02d58fe4c0030`; R2 provider orchestration remains durable at `5826dff6019d453f9eba575ecf67850ac3b19e6a`. |
...
| Latest dirty-state checkpoint | The owner worktree is clean at R3 service/SDK commit `99930529633e02f027ae17adaa8d7379a73af37b` before this recovery-only plan, routing-index, and proof update. Compose restart, machine restart transport, and scheduler-deletion paths remain unchanged. |
