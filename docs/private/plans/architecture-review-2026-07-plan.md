...
Next action: Execute SA1 as the first high lane. Verify and capture fail-before
evidence for the three S3 wire defects, then implement their adapter-owned
repairs and record the modern SDK checksum-header compatibility decision. Keep
the dirty IMV7 closeout worktree unchanged. Keep RR31 deferred during SA1.
