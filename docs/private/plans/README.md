...
- `docs-and-app-verification-reliability-plan.md` - `active` owner for network
  ...
  decisions without reopening them. Hosted checks passed for implementation PR
  #276. The plan waits for owner merge authorization and current-main
  reconciliation before AVR8 starts.
