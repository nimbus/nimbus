...
Status: `active — SUC0–SUC2 + SUC4 complete (PRs #248–#253); SUC3.1 step 5/5 in_progress (steps 1-4 merged, PRs #254/#257/#258/#259); SUC5.1 complete (PR #255); SUC6.1 complete (PR #256); SUC6.2 closed by U7; SUC6.3 closed`
...
| SUC3.1 Provider facade extraction | `in_progress` (steps 1-2 merged, PRs #254/#257: SqlStoreCore + shared executor + libsql on the seam incl. shared sql_commit and its new StorageCommitBeforeVisibility; steps 3-4 landed the U5 witness + U4 gates + five shared transaction-half modules (net −366 step 4; three targets declined with published arithmetic — planner's −800 unreachable behavior-preservingly); step 5 = feature gates) | delete the ~855-line triplicated blocks into one facade; sqlite (with #244/#245 optimizations) is the reference; provider feature gates so embedded builds/measures in isolation | ~−1,700 LoC net; conformance harness green for all providers; sqlite paired A/B unchanged | `suc3/facade.md` | after SUC2; sqlite fork is canonical, not blocked-on |
