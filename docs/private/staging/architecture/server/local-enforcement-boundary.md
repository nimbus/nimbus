...
- [tenant isolation](../../staging/tenant-isolation.md)
- [tenant isolation runbook](../../staging/operating/tenant-isolation.md)
...
- [container image](../../staging/operating/container-image.md)
...
[Node lifecycle](../../staging/operating/node-lifecycle.md). This architecture section
