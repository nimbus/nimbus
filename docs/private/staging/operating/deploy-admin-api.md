...
[Cloud Functions artifact contract](../staging/adapters/cloud-functions/artifact-contract.md) and
[Cloud Functions target binding contract](../staging/adapters/cloud-functions/target-binding-contract.md).
