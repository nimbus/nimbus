...
make bench-libsql-replica-provider WORKLOADS='point-read indexed-query composite-indexed-query barrier-refresh peer-catch-up' ENCRYPTION=temp-master-key-file REPORT=/Users/jack/src/github.com/agentstation/neovex/docs/research/encryption-at-rest-libsql-replica-encrypted-cache-benchmark-report.md
```
...
- report path: `/Users/jack/src/github.com/agentstation/neovex/docs/research/encryption-at-rest-libsql-replica-encrypted-cache-benchmark-report.md`
