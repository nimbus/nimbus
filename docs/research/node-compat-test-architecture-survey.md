...
Source: `wc -l crates/neovex-runtime/src/runtime/tests/node_compat.rs` → 6,904.
...
Batch constants map to numbered slices in `docs/plans/node-lts-compatibility-plan.md`:
...
Source: searched `docs/plans/node-lts-compatibility-plan.md`, `node_compat.rs`,
...
- `scripts/node_compat/generate_matrix.py` — generates the node-compat surface
...
Source: `scripts/node_compat/generate_matrix.py` (60 lines inspected);
...
| Reference | Path |
|-----------|------|
| Neovex node_compat.rs | `crates/neovex-runtime/src/runtime/tests/node_compat.rs` |
| Neovex NLC plan | `docs/plans/node-lts-compatibility-plan.md` |
