...
| `node24` | `default` | `v24.16.0` | 5198 | 632 | 4516 | 50 | 4566 | 5198 | 0 | 12.2% |
...
| `node24` | `tests/runtime/node/classifications/node24.json` | 4516 | 50 | 4566 | `{"Expected failure": 16, "Known gap": 4500, "Skipped / excluded": 50}` | `{"Requires Native Addon Harness": 31, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 64, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 4209, "Requires Wpt Harness": 23, "Rust Watchpoint Expected Failure": 16, "Support Fixture Not Top Level Test": 49, "Upstream Known Issue Or Platform Boundary": 24}` |
