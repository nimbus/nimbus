...
| `node24` | `default` | `v24.16.0` | 5198 | 323 | 4825 | 50 | 4875 | 5198 | 0 | 6.2% |
...
| `node24` | `tests/runtime/node/classifications/node24.json` | 4825 | 50 | 4875 | `{"Expected failure": 23, "Known gap": 4802, "Skipped / excluded": 50}` | `{"Requires Native Addon Harness": 31, "Requires Pseudo Tty Host Harness": 31, "Requires Pummel Stress Harness": 64, "Requires Sequential Host State Harness": 119, "Requires Unpromoted Node Surface": 4511, "Requires Wpt Harness": 23, "Rust Watchpoint Expected Failure": 23, "Support Fixture Not Top Level Test": 49, "Upstream Known Issue Or Platform Boundary": 24}` |
...
- ignored Rust node_compat tests: 77
...
- entries: 77
- by expectation: `{"Expected failure": 77}`
- by classification: `{"Watchpoint": 77}`
- unexpected passes: 0
