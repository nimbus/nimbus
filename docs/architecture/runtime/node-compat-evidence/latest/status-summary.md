...
Counts every vendored lane-local test-* JS/CJS/MJS fixture, then compares that denominator to the documented manifested green subset. The remainder is intentionally reported as unmanifested_or_unclassified, not as pass or fail.

## Lane Summary

| Lane | Role | Upstream | Vendored test files | Documented green | Unmanifested/unclassified | Ratio |
| --- | --- | --- | ---: | ---: | ---: | ---: |
| `node20` | `validation` | `v20.20.2` | 1308 | 913 | 395 | 69.8% |
| `node22` | `primary` | `v22.15.0` | 1283 | 994 | 289 | 77.5% |
| `node24` | `preview` | `v24.15.0` | 1495 | 925 | 570 | 61.9% |
