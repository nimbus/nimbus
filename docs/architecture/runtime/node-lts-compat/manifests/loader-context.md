...
- pinned official Node24 preview corpus:
...
`crates/neovex-runtime/src/runtime/tests/node_compat.rs`; this document keeps
...
- `test/parallel/test-crypto-scrypt.js` *(Node20 and Node22 only; Node24 remains an explicit preview watchpoint for the newer incompatible-option error shape)*
...
- `test/parallel/test-crypto-dh-stateless.js` *(Node20 and Node22 only; Node24 remains an explicit preview watchpoint for the invalid X25519 derivation-error shape)*
...
- `test/parallel/test-domain-add-remove.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-bind-timeout.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-ee-error-listener.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-ee-implicit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-ee.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-enter-exit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-from-timer.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-implicit-binding.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-intercept.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-multiple-errors.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-nested.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-nexttick.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-promise.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-run.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-timer.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-domain-timers.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-constants.js` *(Node22 primary only; Node20 and Node24 are not yet staged for this narrower file)*
- `test/parallel/test-binding-constants.js` *(Node22 primary only; Node20 and Node24 are not yet staged for this narrower file)*
...
- `test/parallel/test-uv-binding-constant.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-api.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-binding.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-bootstrap.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-sys.js`
- `test/parallel/test-sqlite-config.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-sqlite-statement-sync.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-sqlite-template-tag.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-sqlite-named-parameters.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-sea-get-asset-keys.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-repl-definecommand.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-repl-mode.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-repl-recoverable.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-repl-reset-event.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-options-validation.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-initialize-validation.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-start-validation.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-not-started.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-return-on-exit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-stdio.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-main_args.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-write_file.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-stat.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-readdir.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-notdir.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-io.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-preopen_populates.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-fd_prestat_get_refresh.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/wasi/test-wasi-cant_dotdot.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-constructor.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-init.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-isdead.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-isconnected.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-events.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-exit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-disconnect.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-forced-exit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-cluster-worker-kill.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-category-used.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-console.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-dynamic-enable.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-environment.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-metadata.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-none.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
- `test/parallel/test-trace-events-process-exit.js` *(Node22 primary only; Node20 and Node24 are not yet staged in the manifested denominator for this family)*
...
- The first shared-LTS `crypto` KDF/stream wave is now green on Node22 and
  ...
  The only remaining drift in this wave is preview-only: the official Node24
...
- The next shared-LTS `crypto` Diffie-Hellman / ECDH wave is now green across
  ...
  fixture remains an explicit validation-only divergence for the prior
  OpenSSL invalid-secret message, and only the Node24 preview lane still
