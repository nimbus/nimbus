...
| `concepts/architecture/auth-trust.md` | `--allow-network` opt-in + 30-day rotation freshness gate; never-rotated always stale | `crates/nimbus-bin/src/start/network_bind.rs`, `crates/nimbus-operator/src/token.rs` |
