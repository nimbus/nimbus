...
const deploymentUrl = import.meta.env.VITE_NIMBUS_URL ?? "http://localhost:8080/convex/demo";
const client = new NimbusReactClient(deploymentUrl, { skipDeploymentUrlCheck: true });
