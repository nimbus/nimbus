...
use nimbus_tenant::{RuntimeIsolationTier, TenantIsolationDecision, TenantRuntimePolicyAdmission};

#[derive(Debug, Clone, PartialEq, Eq)]
pub enum RuntimeExecutionAdmission {
    InProcess,
    FallbackUnavailable {
...
impl RuntimeExecutionAdmission {
    pub fn for_decision(decision: &TenantIsolationDecision) -> Self {
    ...
    pub fn ensure_in_process_available(self, context: &str) -> Result<()> {
        match self {
            Self::InProcess => Ok(()),
