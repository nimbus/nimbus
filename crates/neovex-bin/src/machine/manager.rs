...
fn requires_host_guest_neovex_sync(config: &MachineConfigRecord) -> bool {
    self::guest::requires_host_guest_neovex_sync(config)
}
...
pub(super) fn inspect_desired_guest_neovex_binary(
    ...
    self::guest::inspect_desired_guest_neovex_binary(paths)
}
...
pub(super) fn inspect_observed_guest_neovex_binary(
    ...
    self::guest::inspect_observed_guest_neovex_binary(config, state)
}

#[cfg(test)]
fn resolve_guest_neovex_binary(paths: &MachinePaths) -> Result<PathBuf, Error> {
    self::guest::resolve_guest_neovex_binary(paths)
}
...
mod tests {
    ...
    use crate::machine::{
        ...
        MachineProvider, MachineResources, MachineRootLayout, MachineVolume,
        describe_machine_image_source, machine_image_reference_repository,
    };
