...
impl RawComposeService {
    fn merge_from(&mut self, overlay: Self) {
        ...
        merge_optional_neovex_plan(&mut self.x_neovex, overlay.x_neovex);
...
fn merge_optional_neovex_plan(
    base: &mut Option<ComposeNeovexPlan>,
    overlay: Option<ComposeNeovexPlan>,
) {
    match (base.as_mut(), overlay) {
