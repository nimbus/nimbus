...
//
// This is served through Neovex's node:perf_hooks builtin override path in the
...
const INTERVAL_HISTOGRAM_CLONE_TYPE = "NeovexIntervalHistogramSnapshot";
const RECORDABLE_HISTOGRAM_CLONE_TYPE = "NeovexRecordableHistogram";
