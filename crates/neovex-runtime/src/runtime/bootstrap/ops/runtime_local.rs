...
static NEOVEX_SHARED_WORKER_ENV: LazyLock<Mutex<BTreeMap<String, String>>> =
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_validate_open_path(
    state: &mut OpState,
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_copy_file(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_copy_file_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsCopyFilePayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let permissions = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_link(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_link_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsLinkPayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let permissions = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_chmod(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_utime(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_utime_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsUtimePayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let path_policy = state
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_chmod_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsChmodPayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let permissions = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_remove(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_remove_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsRemovePayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let path_policy = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_symlink(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_symlink_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsSymlinkPayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let path_policy = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_read_link(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_read_link_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsReadLinkPayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let path_policy = state
...
#[op2]
#[serde]
pub(super) async fn op_neovex_runtime_rename(
    state: Rc<RefCell<OpState>>,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_rename_sync(
    state: &mut OpState,
    #[serde] payload: RuntimeFsRenamePayload,
) -> std::result::Result<RuntimeHostCallEnvelope, JsErrorBox> {
    let path_policy = state
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_shared_env_seed(
...
#[op2]
#[string]
pub(super) fn op_neovex_runtime_shared_env_get(
    #[string] name: String,
...
#[op2]
#[serde]
pub(super) fn op_neovex_runtime_shared_env_snapshot() -> BTreeMap<String, String> {
    NEOVEX_SHARED_WORKER_ENV
        .lock()
        .expect("shared worker env lock should not be poisoned")
        .clone()
...
#[op2(fast)]
pub(super) fn op_neovex_runtime_shared_env_set(
    #[string] name: String,
    #[string] value: String,
) -> std::result::Result<(), JsErrorBox> {
    if !is_valid_shared_env_name(&name) {
...
#[op2(fast)]
pub(super) fn op_neovex_runtime_shared_env_delete(
    #[string] name: String,
) -> std::result::Result<(), JsErrorBox> {
    if !is_valid_shared_env_name(&name) {
        return Err(JsErrorBox::generic(format!(
