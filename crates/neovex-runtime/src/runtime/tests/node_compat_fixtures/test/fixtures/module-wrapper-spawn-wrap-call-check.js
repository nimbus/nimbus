...
global.__neovexSpawnWrapCallCounter = 0;
...
patchedWrapper[0] +=
  'global.__neovexSpawnWrapCallCounter = ' +
  '(global.__neovexSpawnWrapCallCounter || 0) + 1';
...
assert.strictEqual(global.__neovexSpawnWrapCallCounter, 1);
