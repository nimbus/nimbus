...
#[test]
#[ignore = "Pinned Node24 supported-lane divergence: official v24.15.0 test-fs-constants.js expects a newer constant-surface TypeError gate that Neovex has not adopted into the current Node22 contract"]
...
#[test]
#[ignore = "Pinned Node24 supported-lane divergence: official v24.15.0 test-fs-promises-watch.js adds maxQueue and overflow option validation that Neovex has not adopted into the current Node22-based fs.watch contract"]
