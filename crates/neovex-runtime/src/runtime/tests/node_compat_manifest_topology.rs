...
const LOADER_CONTEXT_SUPPLEMENTARY_MODULE_BRIDGE_JSON: &str =
    include_str!("node_compat_manifests/fixtures/loader-context-supplementary-module-bridge.json");
...
const NODE_COMPAT_RS: &str = include_str!("node_compat.rs");
    ...
    let cases = [
        (
            ...
            [
                ...
                (
                    "node24",
                    "runtime::tests::node_compat::node24_preview_lane_executes_manifested_core_semantics_subset",
                ),
            ],
        ),
        (
        ...
        (
            ...
            [
                (
                    "node20",
                    "runtime::tests::node_compat::node20_validation_lane_executes_official_networking_subset",
                ),
                (
                    "node22",
                    "runtime::tests::node_compat::node22_primary_lane_executes_manifested_networking_subset",
                ),
                (
                    "node24",
                    "runtime::tests::node_compat::node24_preview_lane_executes_manifested_networking_subset",
                ),
            ],
        ),
        (
...
fn node_compat_named_preludes_catalog_matches_default_behavior_registry() {
    ...
    for behavior in NodeCompatNamedPreludeBehavior::ALL {
        ...
        assert!(!metadata.preview_lane_only);
    }
...
fn node_compat_profile_capability_model_rejects_ambiguous_seed_entries() {
    ...
    let invalid_execution_class = serde_json::json!({
        ...
        "lane_batches": [
            {
                "lane": "node22",
                "subset_test": "runtime::tests::node_compat::node22_primary_lane_executes_manifested_core_semantics_subset"
            }
        ],
