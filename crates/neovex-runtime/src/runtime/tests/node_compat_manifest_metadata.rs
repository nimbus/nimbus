...
fn node_compat_lane_metadata_files_parse_and_point_at_real_roots() {
    ...
    let cases = [
        (
            ...
            NODE20_JSON,
            "Node20",
            NodeCompatLaneRole::Validation,
            NodeCompatPublicContractRole::MeasuredValidationLane,
            "v20.20.2",
        ),
        (
            "node22",
            NODE22_JSON,
            "Node22",
            NodeCompatLaneRole::Primary,
            NodeCompatPublicContractRole::PrimaryContract,
            "v22.15.0",
        ),
        (
            "node24",
            NODE24_JSON,
            "Node24",
            NodeCompatLaneRole::Preview,
            NodeCompatPublicContractRole::PreviewVisibilityLane,
            "v24.15.0",
        ),
    ];
    ...
    ) in cases
    {
        ...
        assert_eq!(metadata.runtime_execution_target, "Node22");
        assert_eq!(metadata.runtime_limits_profile, "application_node22");
