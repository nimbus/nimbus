...
fn node_compat_manifest_report_summarizes_lane_slice_and_profile_counts_from_execution_plan() {
    ...
    assert_eq!(report.lane_summaries[0].lane_role, "validation");
    assert_eq!(
...
fn node_compat_manifest_report_builds_catalog_summary_deterministically() {
    ...
    assert_eq!(json["family_count"], 9);
    assert_eq!(json["slice_count"], 9);
    assert_eq!(json["total_unique_fixture_seed_count"], 54);
    assert_eq!(json["total_lane_fixture_entries"], 159);
    assert_eq!(
        json["profile_summaries"],
        serde_json::json!([
            {
                "profile": "Application",
                "total_unique_fixture_seed_count": 54,
                "total_lane_fixture_entries": 159,
                "slice_count_with_entries": 9
            }
        ])
    );
    assert_eq!(
        ...
        serde_json::json!([
            ...
            },
            {
                ...
                "lane_role": "primary",
                "public_contract_role": "primary_contract",
                "runtime_execution_target": "Node22",
                "runtime_limits_profile": "application_node22",
            ...
            },
            {
                ...
                "lane_role": "preview",
                "public_contract_role": "preview_visibility_lane",
                "runtime_execution_target": "Node22",
                "runtime_limits_profile": "application_node22",
                "total_fixture_entries": 53,
                "slice_count_with_entries": 9
            }
        ])
    );
    ...
    assert_eq!(slice_reports.len(), 9);
    assert_eq!(slice_reports[0]["family"], "core-semantics");
    assert_eq!(slice_reports[8]["family"], "streams-and-local-io");
}
        ...
        serde_json::json!([
            {
                ...
                "runtime_execution_target": "Node22",
                "runtime_limits_profile": "application_node22",
                "subset_test": "runtime::tests::node_compat::node20_validation_lane_executes_official_networking_subset",
            ...
            },
            {
                ...
                "runtime_execution_target": "Node22",
                "runtime_limits_profile": "application_node22",
                "subset_test": "runtime::tests::node_compat::node22_primary_lane_executes_manifested_networking_subset",
                "expected_fixture_count": 10,
                "observed_fixture_count": 1,
                "counts": {
                    "passed": 0,
            ...
            },
            {
                ...
                "runtime_execution_target": "Node22",
                "runtime_limits_profile": "application_node22",
                "subset_test": "runtime::tests::node_compat::node24_preview_lane_executes_manifested_networking_subset",
...
fn node_compat_manifest_report_writes_artifacts_deterministically() {
    ...
    assert_eq!(catalog_plan_json["family_count"], 9);
    assert_eq!(
