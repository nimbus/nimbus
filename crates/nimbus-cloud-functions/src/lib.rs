...
pub use app_contract::{
    CloudFunctionsAdminImport, CloudFunctionsAppLayout, CloudFunctionsFirebaseCodebase,
    CloudFunctionsFirebaseProjectLayout, CloudFunctionsFrameworkPackageLayout,
...
pub use trigger_executor::CloudFunctionsTriggerExecutor;
...
pub const CLOUD_FUNCTIONS_INTERNAL_ARTIFACT_DIR: &str = ".nimbus/firebase";
pub const CLOUD_FUNCTIONS_ARTIFACT_MANIFEST_FILE: &str = "artifact.json";
pub const CLOUD_FUNCTIONS_TARGETS_MANIFEST_FILE: &str = "targets.json";
pub const CLOUD_FUNCTIONS_RUNTIME_BUNDLE_FILE: &str = "bundle.mjs";
pub const CLOUD_FUNCTIONS_RUNTIME_BUNDLE_SHA256_FILE: &str = "bundle.sha256";
...
pub enum RuntimeArtifactFamily {
    CloudFunctions,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsImportResolutionStrategy {
    DeployAliasLayer,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CloudFunctionsImportResolution {
    pub strategy: CloudFunctionsImportResolutionStrategy,
    pub covered_specifiers: Vec<String>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CloudFunctionsArtifactManifest {
    pub version: u16,
    pub family: RuntimeArtifactFamily,
    pub runtime_bundle: RuntimeBundleArtifact,
    pub targets_manifest: String,
    pub import_resolution: CloudFunctionsImportResolution,
}
...
pub fn covered_import_specifiers() -> Vec<String> {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsAuthoringSurface {
    FirebaseV2,
    FunctionsFramework,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsSignatureType {
    Http,
    CloudEvent,
    Event,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsHttpExposure {
    Http,
    Callable,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsRootApi {
    SetGlobalOptions,
    OnInit,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsDefaultSurface {
    FirestoreDocument,
    HttpsRequest,
    HttpsCallable,
}
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum CloudFunctionsGlobalOptionField {
    Retry,
    Region,
    Memory,
    TimeoutSeconds,
...
pub struct CloudFunctionsGlobalDefaults {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize, Default)]
pub struct CloudFunctionsDocumentTriggerDefaults {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub retry: Option<bool>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CloudFunctionsTargetsManifest {
    pub version: u16,
    pub targets: Vec<CloudFunctionsTargetDefinition>,
}

impl CloudFunctionsTargetsManifest {
    pub fn v1(targets: Vec<CloudFunctionsTargetDefinition>) -> Result<Self> {
        let manifest = Self {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
pub struct CloudFunctionsTargetDefinition {
    pub name: String,
    pub entrypoint: String,
    pub authoring_surface: CloudFunctionsAuthoringSurface,
    pub signature_type: CloudFunctionsSignatureType,
    pub binding: CloudFunctionsTargetBinding,
}
...
pub enum CloudFunctionsTargetBinding {
    FirestoreDocument {
...
pub fn validate_root_api(api: CloudFunctionsRootApi) -> Result<()> {
    match api {
...
pub fn validate_global_option_support(
