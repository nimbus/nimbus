...
const FIRESTORE_LISTEN_AUTH_SUBPROTOCOL_PREFIX: &str = "neovex.firebase.auth.";
pub(crate) const FIRESTORE_LISTEN_WEBSOCKET_PROTOCOL: &str = "neovex.firebase.listen.v1";
