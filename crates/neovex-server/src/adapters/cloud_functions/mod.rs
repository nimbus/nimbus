...
use neovex_core::{DocumentTriggerPattern, Error, FirestoreCloudEventType, Result};
...
pub(crate) const CLOUD_FUNCTIONS_INTERNAL_ARTIFACT_DIR: &str = ".neovex/firebase";
...
///
/// Unchanged upstream imports are preserved by a Neovex-owned build/deploy
...
mod tests {
    ...
    fn cloud_functions_artifacts_use_sibling_firebase_namespace() {
        assert_eq!(CLOUD_FUNCTIONS_INTERNAL_ARTIFACT_DIR, ".neovex/firebase");
