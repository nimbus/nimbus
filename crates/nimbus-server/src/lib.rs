...
pub use tenant::{
    ...
    OperatorServicePolicy, OperatorStoragePolicy, OperatorVolumePolicy, RuntimeIsolationTier,
    SLSA_PROVENANCE_V1_PREDICATE_TYPE, TENANT_ISOLATION_EVENT_SCHEMA_VERSION,
