...
pub use tenant_isolation::{
    ...
    SlsaVerifierBackend, TENANT_ISOLATION_EVENT_SCHEMA_VERSION, TenantAuditRedactionPolicy,
    TenantImageAdmission, TenantImageAdmissionSource, TenantImageAttestationEvidence,
    TenantImagePolicyDecision, TenantImageProvenanceRequirement, TenantImageSignatureEvidence,
