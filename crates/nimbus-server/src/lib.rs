...
pub use tenant_isolation::{
    ...
    OperatorVolumePolicy, RuntimeIsolationTier, TENANT_ISOLATION_EVENT_SCHEMA_VERSION,
    TenantAuditRedactionPolicy, TenantImageAdmission, TenantImageAdmissionSource,
    TenantImageAttestationEvidence, TenantImagePolicyDecision, TenantImageSignatureEvidence,
    TenantImageVerificationEvidence, TenantImageVerificationProvider, TenantIsolationAuditRecord,
