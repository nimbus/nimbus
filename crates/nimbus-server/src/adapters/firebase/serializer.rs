...
impl FirestoreValue {
    ...
    pub(crate) fn into_nimbus_value(self) -> Result<Value, FirestoreProtoJsonError> {
        match self {
    ...
    pub(crate) fn try_from_nimbus_value(value: &Value) -> Result<Self, FirestoreProtoJsonError> {
        match value {
