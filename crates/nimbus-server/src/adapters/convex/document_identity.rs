...
pub(in crate::adapters::convex) fn encode_convex_document_id(
    table: &TableName,
...
pub(in crate::adapters::convex) fn resolve_convex_document_id(
    table: &TableName,
    document_id: DocumentId,
...
pub(in crate::adapters::convex) fn document_to_convex_json(
    document: Document,
) -> Result<Value, Error> {
...
pub(in crate::adapters::convex) fn documents_to_convex_json(
...
pub(in crate::adapters::convex) fn page_to_convex_json(
    table: &TableName,
    mut page: Page,
) -> Result<Value, Error> {
...
pub(in crate::adapters::convex) fn replace_id_in_value(
    table: &TableName,
    value: &mut Value,
) -> Result<(), Error> {
    match value {
