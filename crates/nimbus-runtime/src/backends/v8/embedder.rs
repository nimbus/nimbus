...
pub(crate) use deno_core::{
    CancelFuture, CancelHandle, Extension, ExtensionFileSource, ExtensionFileSourceCode,
    ExtensionSourceProvider, JsRuntime, JsRuntimeForSnapshot, ModuleCodeString, ModuleLoadOptions,
