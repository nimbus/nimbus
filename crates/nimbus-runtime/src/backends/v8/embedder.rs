...
pub(crate) use deno_core::{
    CancelFuture, CancelHandle, Extension, ExtensionFileSource, ExtensionFileSourceCode, JsRuntime,
    JsRuntimeForSnapshot, ModuleCodeString, ModuleLoadOptions, ModuleLoadReferrer,
