...
use self::async_effects::{
    ...
    op_nimbus_document_insert, op_nimbus_document_patch, op_nimbus_http_route,
};
use self::async_query::{
    op_nimbus_ctx_paginated_query, op_nimbus_ctx_query, op_nimbus_ctx_query_collect,
    op_nimbus_ctx_query_first, op_nimbus_ctx_query_paginate, op_nimbus_ctx_query_take,
    op_nimbus_ctx_query_unique, op_nimbus_document_get,
};
...
use self::runtime_local::{
    ...
    op_nimbus_runtime_chmod_sync, op_nimbus_runtime_copy_file, op_nimbus_runtime_copy_file_sync,
    op_nimbus_runtime_env_get, op_nimbus_runtime_env_snapshot, op_nimbus_runtime_exec_path,
    op_nimbus_runtime_fs_read_file, op_nimbus_runtime_fs_write_file, op_nimbus_runtime_link,
    op_nimbus_runtime_link_sync, op_nimbus_runtime_mkdir, op_nimbus_runtime_mkdir_sync,
    op_nimbus_runtime_read_dir, op_nimbus_runtime_read_dir_sync, op_nimbus_runtime_read_link,
    op_nimbus_runtime_read_link_sync, op_nimbus_runtime_remove, op_nimbus_runtime_remove_sync,
    op_nimbus_runtime_rename, op_nimbus_runtime_rename_sync, op_nimbus_runtime_require_read_file,
...
use self::worker_threads::{
    ...
    op_nimbus_worker_bootstrap_state, op_nimbus_worker_parent_post_message,
    op_nimbus_worker_parent_post_message_raw, op_nimbus_worker_parent_recv_message,
    op_nimbus_worker_parent_recv_message_sync,
};
...
extension!(
    ...
    ops = [
        ...
        op_nimbus_runtime_link,
        op_nimbus_runtime_link_sync,
        op_nimbus_runtime_stat,
        op_nimbus_runtime_stat_sync,
        op_nimbus_runtime_mkdir,
        op_nimbus_runtime_mkdir_sync,
        op_nimbus_runtime_chmod,
        op_nimbus_runtime_chmod_sync,
        op_nimbus_runtime_utime,
        op_nimbus_runtime_utime_sync,
        op_nimbus_runtime_read_dir,
        op_nimbus_runtime_read_dir_sync,
        op_nimbus_runtime_remove,
        op_nimbus_runtime_remove_sync,
        op_nimbus_runtime_symlink,
        op_nimbus_runtime_symlink_sync,
        op_nimbus_runtime_read_link,
        op_nimbus_runtime_read_link_sync,
        op_nimbus_runtime_rename,
        op_nimbus_runtime_rename_sync,
        op_nimbus_runtime_require_resolve,
        op_nimbus_runtime_require_read_file,
        op_nimbus_runtime_env_get,
        op_nimbus_runtime_env_snapshot,
        op_nimbus_runtime_shared_env_get,
        op_nimbus_runtime_shared_env_seed,
        op_nimbus_runtime_shared_env_snapshot,
        op_nimbus_runtime_shared_env_set,
        op_nimbus_runtime_shared_env_delete,
        ...
        op_nimbus_worker_bootstrap_state,
        op_nimbus_worker_parent_post_message,
        op_nimbus_worker_parent_post_message_raw,
        op_nimbus_worker_parent_recv_message,
        op_nimbus_worker_parent_recv_message_sync,
        op_http_start,
        op_set_raw
    ],
...
#[cfg(test)]
extension!(
    nimbus_runtime_test_ext,
    ops = [
        op_nimbus_runtime_test_spawn,
        op_nimbus_runtime_test_spawn_sync,
        op_nimbus_runtime_test_force_gc
    ],
);

#[cfg(test)]
pub(crate) fn runtime_test_extension() -> Extension {
    nimbus_runtime_test_ext::init()
}
