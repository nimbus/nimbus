...
const NIMBUS_NODE_FS_SPECIFIER: &str = "nimbus:node/fs";
const NODE_FS_PROMISES_SPECIFIER: &str = "node:fs/promises";
const NIMBUS_NODE_FS_PROMISES_SPECIFIER: &str = "nimbus:node/fs/promises";
...
const NIMBUS_NODE_MODULE_SPECIFIER: &str = "node:nimbus/module";
const INTERNAL_READLINE_UTILS_SPECIFIER: &str = "internal/readline/utils";
const NIMBUS_INTERNAL_READLINE_UTILS_SPECIFIER: &str = "nimbus:internal/readline/utils";
const NODE_PERF_HOOKS_MODULE_SOURCE: &str = r#"
export * from "ext:nimbus_node22/perf_hooks_impl.js";
import defaultExport from "ext:nimbus_node22/perf_hooks_impl.js";
