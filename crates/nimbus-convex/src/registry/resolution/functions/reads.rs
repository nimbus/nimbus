...
impl ConvexRegistry {
    pub fn resolve_query(&self, name: &str, args: &Value) -> Result<ConvexExecutableQuery, Error> {
        self.resolve_query_for_visibility(name, args, ConvexFunctionVisibility::Public)
    }

    pub fn resolve_query_for_visibility(
        &self,
        name: &str,
        args: &Value,
    ...
    pub fn resolve_subscription_query(
        &self,
        name: &str,
        args: &Value,
    ) -> Result<ConvexExecutableQuery, Error> {
    ...
    pub fn resolve_subscription_query_for_visibility(
        &self,
        name: &str,
        args: &Value,
        required_visibility: ConvexFunctionVisibility,
    ...
    pub fn resolve_paginated_query_for_visibility(
        &self,
        name: &str,
        args: &Value,
        page_size: usize,
