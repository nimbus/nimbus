use nimbus_runtime::{HOST_CALL_ABI_VERSION, HostCallOperation, HostCallRequest};
...
pub enum ConvexHostCallOperation {
...
impl ConvexHostCallOperation {
    pub const fn family(self) -> ConvexHostCallFamily {
        match self {
            Self::HttpRoute
            | Self::CtxQuery
...
pub struct ConvexHostCallRequest {
    #[serde(default = "default_convex_host_call_abi_version")]
    pub abi_version: u16,
    pub operation: ConvexHostCallOperation,
    #[serde(default)]
    pub payload: Value,
}
...
pub fn convex_host_operation_name(operation: HostCallOperation) -> &'static str {
