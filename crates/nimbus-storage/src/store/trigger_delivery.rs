...
impl TenantStore {
    pub fn trigger_delivery_cursor(&self) -> Result<TriggerDeliveryCursor> {
        ...
        let materialized_through = metadata
            ...
            .transpose()?
            .unwrap_or(0);
        Ok(TriggerDeliveryCursor::new(nimbus_core::SequenceNumber(
...
mod tests {
    ...
    fn trigger_delivery_cursor_round_trips_in_redb_metadata() {
        ...
        store
            .set_trigger_delivery_cursor(TriggerDeliveryCursor::new(nimbus_core::SequenceNumber(
                42,
            )))
        ...
        assert_eq!(
            ...
            TriggerDeliveryCursor::new(nimbus_core::SequenceNumber(42))
        );
    }
}
