...
const CONTEXT_VERSION_KEY: &str = "nimbus:manifest_version";
const CONTEXT_CIPHER_KEY: &str = "nimbus:manifest_cipher";
const CONTEXT_SUBJECT_KEY: &str = "nimbus:subject_descriptor";
const CONTEXT_PROVIDER_KEY: &str = "nimbus:key_provider";
const CONTEXT_CREATED_AT_KEY: &str = "nimbus:created_at";
const CONTEXT_ROTATED_AT_KEY: &str = "nimbus:rotated_at";
...
mod tests {
    ...
    impl AwsEnvGuard {
        fn install() -> Self {
            ...
            unsafe {
                std::env::set_var("AWS_ACCESS_KEY_ID", "nimbus-test");
                std::env::set_var("AWS_SECRET_ACCESS_KEY", "nimbus-test-secret");
    ...
    async fn generate_and_unwrap_round_trip_with_bound_encryption_context() {
        ...
        assert_eq!(requests[0].body["KeyId"], "alias/nimbus-test");
    ...
    async fn provider_native_rewrap_uses_reencrypt_with_old_and_new_context() {
        ...
        assert_eq!(requests[0].body["DestinationKeyId"], "alias/nimbus-test");
    }
}
