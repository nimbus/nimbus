...
async fn mysql_committer_lease_transitions_use_provider_time_and_fence_stale_owners() {
...
#[tokio::test(flavor = "multi_thread")]
async fn mysql_committer_lease_concurrent_acquire_has_exactly_one_winner() {
    with_test_provider(|provider, _config| async move {
