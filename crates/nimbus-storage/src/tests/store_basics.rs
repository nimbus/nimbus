...
fn store_reopens_with_typed_scalar_metadata_intact() {
    ...
    document.set_typed_field(
        "updatedAt",
        nimbus_core::TypedScalarValue::Timestamp {
            value: Timestamp(1_234),
        },
    );
    document.set_typed_field(
        "ceiling",
        nimbus_core::TypedScalarValue::SpecialDouble {
            value: nimbus_core::SpecialDouble::PositiveInfinity,
        },
    );
    ...
    assert_eq!(
        ...
        Some(&nimbus_core::TypedScalarValue::Timestamp {
            value: Timestamp(1_234),
        })
    );
    ...
    assert_eq!(
        ...
        Some(&nimbus_core::TypedScalarValue::SpecialDouble {
            value: nimbus_core::SpecialDouble::PositiveInfinity,
        })
    );
