...
use super::{
    Document, DocumentId, FieldSchema, FieldType, IndexDefinition, SchemaChangeEvent,
    SequenceNumber, TableId, TableName, TableSchema, TenantEventRecord, Timestamp, WriteOp,
    WriteOpType,
};
use nimbus_core::{
    HistoricalReadShape, HistoricalReadSnapshot, Mutation, Result, ScheduledJob, TableState,
};
...
pub(crate) fn historical_snapshot(sequence: SequenceNumber) -> HistoricalReadSnapshot {
