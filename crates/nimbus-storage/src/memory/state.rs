...
pub(super) struct MemoryState {
    ...
    pub retention_document_version_floor: SequenceNumber,
    pub retention_index_version_floor: SequenceNumber,
...
impl MemoryState {
    pub fn with_id_source(id_source: Arc<dyn IdSource>) -> Self {
        Self {
            ...
            retention_document_version_floor: SequenceNumber(0),
            retention_index_version_floor: SequenceNumber(0),
