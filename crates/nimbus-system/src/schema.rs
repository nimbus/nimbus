    ...
    Ok(vec![
        ...
        table(
            ...
            &[
                ...
                string("name", true),
                string("kind", true),
                string("sourceGeneration", true),
                string("attachmentId", true),
                string("generation", true),
                string("attachmentProviderId", true),
                string("observedPhase", true),
                array("endpoints", true),
                array("conditions", true),
                string("cleanupState", true),
                object("health", false),
            ],
            &[
        ...
        table(
            ...
            &[
                string("routeId", true),
                string("serviceId", true),
                string("tenantId", true),
                string("endpointId", true),
                string("listenerId", true),
                string("portLeaseId", true),
                string("generation", true),
                string("leaseEpoch", true),
                string("providerId", true),
                string("protocol", true),
                string("actualAddress", true),
                string("observedPhase", true),
                array("conditions", true),
                string("cleanupState", true),
            ],
        ...
        table(
            ...
            &[
                ...
                string("protocol", true),
                string("generation", true),
                string("leaseEpoch", false),
                string("providerId", false),
                string("actualAddress", true),
                string("observedPhase", true),
                array("conditions", true),
                string("cleanupState", true),
