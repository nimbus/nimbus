...
pub const LOCAL_ADMIN_HEADER_NAME: &str = "x-nimbus-admin-token";
...
impl LocalServerRouteFamily {
    ...
    pub fn classify_request(path: &str, headers: &HeaderMap) -> Self {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct ParsedOrigin<'a> {
    pub scheme: &'a str,
    pub host: &'a str,
    pub port: Option<u16>,
}

pub fn parse_origin(origin: &HeaderValue) -> Option<ParsedOrigin<'_>> {
...
pub fn is_loopback_origin(origin: ParsedOrigin<'_>, port: Option<u16>) -> bool {
