...
- you want OEM, embedded, white-label, or redistribution rights beyond the
  community license
- you need custom legal, procurement, security, compliance, support, or
  indemnity terms

## What a commercial license can cover

A commercial agreement may include rights such as:

- production use above the free-use threshold
- hosted or managed service rights
- OEM and embedded distribution rights
- support, SLAs, and private support channels
- negotiated security and compliance terms
- private patches, roadmap coordination, or deployment assistance

## Trial for larger organizations

If your organization first exceeds both `$10M` USD annual revenue and `500`
monthly active users, you receive a one-time `90-day` trial under the community
license.
