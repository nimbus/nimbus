...
faas_profile = repo / "tests/runtime/node/compat/node-faas-compatibility-profile.json"
release_train = repo / "tests/runtime/node/compat/node-lts-compat/node-release-train.json"
compat_doc = repo / "tests/runtime/node/published/nodejs/compatibility.md"
api_reference = repo / "tests/runtime/node/published/nodejs/reference/node-apis.md"
package_reference = repo / "tests/runtime/node/published/nodejs/reference/packages.md"
fundamentals = repo / "tests/runtime/node/published/nodejs/fundamentals.md"
