...
make_executable_stub "${output_dir}/nimbus-crun-linux-amd64" "nimbus-crun 1.29.1-nimbus.2 x86_64"
make_executable_stub "${output_dir}/nimbus-crun-linux-arm64" "nimbus-crun 1.29.1-nimbus.2 aarch64"
...
"${container_runtime}" run --rm \
  ...
  bash -lc '
    ...
    rpmbuild --rebuild /work/output/amd64/srpms/nimbus-crun-1.29.1.nimbus.2-1.src.rpm
    ...
    rpmbuild --rebuild --target aarch64 /work/output/arm64/srpms/nimbus-crun-1.29.1.nimbus.2-1.src.rpm
...
test -f "${output_dir}/amd64/srpms/nimbus-crun-1.29.1.nimbus.2-1.src.rpm"
...
test -f "${output_dir}/arm64/srpms/nimbus-crun-1.29.1.nimbus.2-1.src.rpm"
...
grep -F "nimbus-crun 1.29.1-nimbus.2 x86_64" "${output_dir}/amd64-nimbus-crun.command.txt" >/dev/null
