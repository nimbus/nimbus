...
| --- | --- | --- | --- | --- |
| consumed | `nimbus/deno` | `v2.9.6-nimbus.14` | `ca82932e424034472269ee647ca77d75353039f9` | Deno 2.9.6 with the selected Locker, egress, Node heap-policy, lazy-ESM, packaged extension-source, and Node network and HTTP compatibility contracts |
