...
| --- | --- | --- | --- | --- |
| consumed | `nimbus/deno` | `v2.9.6-nimbus.13` | `86da013cdd60e2ff76988507f25bd6f87faea319` | Deno 2.9.6 with the selected Locker, egress, Node heap-policy, lazy-ESM, packaged extension-source, and Node network and HTTP compatibility contracts |
