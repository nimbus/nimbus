...
| --- | --- | --- | --- | --- |
| consumed | `nimbus/deno` | `v2.9.6-nimbus.15` | `fea827162d8e4e7b8bfb4896c6631197d88c1dc7` | Deno 2.9.6 with the selected Locker, egress, Node heap-policy, lazy-ESM, packaged extension-source, and Node network and HTTP compatibility contracts |
