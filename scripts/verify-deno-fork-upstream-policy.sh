...
EXPECTED_DENO_TAG="v2.8.1-nimbus.3"
EXPECTED_DENO_SHA="b31e08b776df3090d27593be7465c9cb73abee1e"
...
require_contains "${LEDGER_DOC}" 'b31e08b776df3090d27593be7465c9cb73abee1e' "Ledger records latest current nimbus/deno carried patch"
