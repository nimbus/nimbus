...
LEDGER_DOC="docs/architecture/runtime/deno-fork-bump-ledger.md"

EXPECTED_DENO_TAG="v2.8.1-nimbus.1"
EXPECTED_DENO_SHA="18f76a9a19ab74d49d9a40037733cc4aec983d26"
...
require_contains "${LEDGER_DOC}" 'ab9d720179273bb23c11523247683c814f09f87c' "Ledger records first current nimbus/deno carried patch"
require_contains "${LEDGER_DOC}" '18f76a9a19ab74d49d9a40037733cc4aec983d26' "Ledger records latest current nimbus/deno carried patch"
