...
EXPECTED_DENO_TAG="v2.8.0-nimbus.15"
EXPECTED_DENO_SHA="1f101bf0032a223463507f500ddd236afebd9fcc"
...
require_contains "${LEDGER_DOC}" '1f101bf0032a223463507f500ddd236afebd9fcc' "Ledger records latest current nimbus/deno carried patch"
