...
forks_tsv=$(cat <<EOF
nimbus/deno	${HOME}/src/github.com/nimbus/deno	full_source	nimbus/v2.9.6	git@github.com:nimbus/deno.git	git@github.com:denoland/deno.git	v2.9.6	v2.9.6-nimbus.5	v[0-9]*	yes	v2.9.6
...
nimbus/bun	${HOME}/src/github.com/nimbus/bun	full_source	nimbus/bun-v1.4.0	git@github.com:nimbus/bun.git	git@github.com:oven-sh/bun.git	bun-v1.4.0	bun-v1.4.0-nimbus.8	bun-v[0-9]*	yes	34cbb9a40b
