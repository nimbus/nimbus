...
forks_tsv=$(cat <<EOF
nimbus/deno	${HOME}/src/github.com/nimbus/deno	full_source	nimbus/v2.9.6	git@github.com:nimbus/deno.git	git@github.com:denoland/deno.git	v2.9.6	v2.9.6-nimbus.4	v[0-9]*	yes	v2.9.6
