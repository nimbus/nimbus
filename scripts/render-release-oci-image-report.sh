...
latest_digest="none"
output=""
scanner_image="docker/scout-cli:1.20.0@sha256:734b589e8aa407af8a1343d390bd44a84d283b3e0cb23b24308e73b6be9232d4"
...
vulnerability_scan_command=docker run --rm ${scanner_image} cves --format sarif --output ${vuln_asset} registry://${multi_ref}
