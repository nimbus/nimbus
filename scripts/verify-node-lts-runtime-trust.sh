...
lane_registry = repo / "tests/runtime/node/compat/node-lts-compat/node-lts-lanes.json"
compat_doc = repo / "tests/runtime/node/published/nodejs/compatibility.md"
node_readme = repo / "tests/runtime/node/published/nodejs/README.md"
evidence_latest = repo / "tests/runtime/node/published/nodejs/evidence/latest.md"
supplementary_failures = repo / "tests/runtime/node/compat/node-compat-supplementary-failures.md"
