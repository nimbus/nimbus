...
DEFAULT_CATALOG_PATH = Path("tests/node-compat/expectations/rust-watchpoints.json")
...
def expectation_for_entry(test_name: str | None, reason: str) -> tuple[str, str]:
    if test_name is not None and test_name.startswith("node24_preview_lane_executes_"):
        return ("expected_skip", "preview_lane_gate")
