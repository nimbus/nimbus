...
def build_inventory(lane: str) -> dict[str, Any]:
    ...
    rust_referenced_tests = extract_rust_referenced_tests(vendored_test_set)
    ...
    return {
        ...
        "counts": {
            ...
            "documented_or_classified_count": documented_green + classified_non_green,
...
def build_markdown(inventory: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"| Documented green | {counts['documented_manifested_green_count']} |",
        f"| Classified non-green | {counts['classified_non_green_count']} |",
