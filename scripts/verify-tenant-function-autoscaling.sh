...
FUNCTION_SCALING="crates/nimbus-bin/src/function_scaling.rs"
...
EXPLAIN="crates/nimbus-bin/src/explain.rs"
ROUTER="crates/nimbus-server/src/router.rs"
RUNTIME_POLICY="crates/nimbus-runtime/src/limits/policy.rs"
START_TESTS="crates/nimbus-bin/src/start/tests/cli_surface.rs"
...
require_contains "$CONVEX_RUNTIME_ACCESS" 'convex_registry_applies_selector_scaling_plan_set_to_runtime_lanes' "convex registry tests selector-aware runtime lane plans"
