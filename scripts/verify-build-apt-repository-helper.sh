...
create_stub_deb "nimbus-libkrun" "1.19.4~nimbus.3" "amd64" "/usr/libexec/nimbus/lib/libkrun.so.1" \
  "Provides: nimbus-libkrun"
create_stub_deb "nimbus-crun" "1.29.1~nimbus.2" "amd64" "/usr/libexec/nimbus/crun" \
  "Depends: nimbus-libkrun"
create_stub_deb "nimbus" "0.1.10" "arm64" "/usr/bin/nimbus" \
  "Depends: nimbus-crun, buildah, conmon, netavark, aardvark-dns" \
  "Recommends: fuse-overlayfs, uidmap"
create_stub_deb "nimbus-libkrun" "1.19.4~nimbus.3" "arm64" "/usr/libexec/nimbus/lib/libkrun.so.1" \
  "Provides: nimbus-libkrun"
create_stub_deb "nimbus-crun" "1.29.1~nimbus.2" "arm64" "/usr/libexec/nimbus/crun" \
  "Depends: nimbus-libkrun"
...
grep -F "Filename: pool/main/amd64/nimbus-libkrun_1.19.4~nimbus.3_amd64.deb" "${repo_dir}/dists/stable/main/binary-amd64/Packages" >/dev/null
grep -F "Filename: pool/main/amd64/nimbus-crun_1.29.1~nimbus.2_amd64.deb" "${repo_dir}/dists/stable/main/binary-amd64/Packages" >/dev/null
grep -F "Filename: pool/main/arm64/nimbus_0.1.10_arm64.deb" "${repo_dir}/dists/stable/main/binary-arm64/Packages" >/dev/null
grep -F "Filename: pool/main/arm64/nimbus-libkrun_1.19.4~nimbus.3_arm64.deb" "${repo_dir}/dists/stable/main/binary-arm64/Packages" >/dev/null
grep -F "Filename: pool/main/arm64/nimbus-crun_1.29.1~nimbus.2_arm64.deb" "${repo_dir}/dists/stable/main/binary-arm64/Packages" >/dev/null
