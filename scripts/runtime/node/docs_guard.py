...
SUPPORT_DOCS = (
    ...
    "docs/runtimes/nodejs/reference/shims-and-boundaries.md",
...
REQUIRED_SNIPPETS = {
    ...
    "docs/runtimes/nodejs/compatibility.md": (
        ...
        "well-supported default label is held until NDS closeout",
        "reference/shims-and-boundaries.md",
    ),
    "docs/runtimes/nodejs/configuration.md": (
    ...
    "docs/runtimes/nodejs/reference/shims-and-boundaries.md": (
        ...
        "diagnostic",
        "unsupported",
        "Diagnostic entries are not positive support claims.",
    ),
    "docs/architecture/runtime/node-compat-surface-matrix.md": (
        "Product default is a routing default, not an evidence priority.",
