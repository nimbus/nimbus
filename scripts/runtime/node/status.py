...
def public_node22_claim_count() -> int | None:
    doc_path = repo_root() / "docs/private/architecture/runtime/deno-vs-nimbus-node-compat.md"
            ...
            warnings.append(
                {
                    ...
                    "documented_manifested_green_count": documented_green,
                    "doc_path": "docs/private/architecture/runtime/deno-vs-nimbus-node-compat.md",
                }
            )
    return {
        "schema_version": 2,
