...
Company grants the Maintainer a perpetual, worldwide, non-exclusive,
...
Company grants the Maintainer and recipients of software distributed by the
...
- Company has the authority to enter into this CCLA
- Company has obtained or will obtain authority from each Authorized Contributor
  needed for Company to grant the rights in this CCLA
- to the best of Company's knowledge, Contributions submitted on its behalf do
  not intentionally include material that Company lacks the right to contribute

## 5. Authorized contributors

Company is responsible for identifying Authorized Contributors through a written
notice, signature process, pull request workflow, or other method reasonably
accepted by the Maintainer.

## 6. No obligation

Nothing in this CCLA requires the Maintainer to use, accept, or distribute any
Contribution.

## 7. As-is

Except as expressly stated above, Company provides Contributions as-is, without
