...
You retain ownership of Your Contributions. You grant the Maintainer a
...
- You are legally entitled to grant the rights in this ICLA
- each Contribution is Your original work, or You have the right to submit it
- to the best of Your knowledge, each Contribution does not intentionally
  include material that You are not allowed to submit
- if You become aware of third-party restrictions that may apply to a
  Contribution, You will promptly notify the Maintainer

## 5. Employer and third-party approvals

You are responsible for obtaining any approvals needed from Your employer,
client, school, or other third party before making a Contribution.

## 6. No obligation

Nothing in this ICLA requires the Maintainer to use, accept, or distribute any
Contribution.

## 7. As-is

Except as expressly stated above, You provide Contributions as-is, without any
