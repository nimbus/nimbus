...
> [Convex compatibility reference](../../docs/private/staging/adapters/convex/compatibility.md)
> for the precise support matrix, and **always read**
> [`docs/private/staging/adapters/convex/ai-guidelines.md`](../../docs/private/staging/adapters/convex/ai-guidelines.md)
...
- [Convex adapter docs](../../docs/private/staging/adapters/convex/README.md)
