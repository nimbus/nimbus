...
import type { MethodOptions } from "../protobuf/descriptor_pb.ts";
import { file_google_protobuf_descriptor } from "../protobuf/descriptor_pb.ts";
...
export type RoutingRuleJson = {
   ...
   * @generated from field: repeated google.api.RoutingParameter routing_parameters = 2;
   */
  routingParameters?: RoutingParameterJson[];
};
 ...
 */
export const RoutingRuleSchema: GenMessage<RoutingRule, {jsonType: RoutingRuleJson}> = /*@__PURE__*/
 ...
 * @generated from message google.api.RoutingParameter
 */
export type RoutingParameterJson = {
  /**
   * A request field to extract the header key-value pair from.
   *
   * @generated from field: string field = 1;
 ...
 */
export const RoutingParameterSchema: GenMessage<RoutingParameter, {jsonType: RoutingParameterJson}> = /*@__PURE__*/
