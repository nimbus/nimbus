 ...
 */
export const DocumentMaskSchema: GenMessage<DocumentMask, {jsonType: DocumentMaskJson}> = /*@__PURE__*/
 ...
 */
export const PreconditionSchema: GenMessage<Precondition, {jsonType: PreconditionJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.TransactionOptions
 */
export type TransactionOptionsJson = {
  /**
   * The transaction can only be used for read operations.
   *
   * @generated from field: google.firestore.v1.TransactionOptions.ReadOnly read_only = 2;
   */
  readOnly?: TransactionOptions_ReadOnlyJson;
   ...
   * @generated from field: google.firestore.v1.TransactionOptions.ReadWrite read_write = 3;
   */
  readWrite?: TransactionOptions_ReadWriteJson;
};
 ...
 */
export const TransactionOptionsSchema: GenMessage<TransactionOptions, {jsonType: TransactionOptionsJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.TransactionOptions.ReadWrite
 */
export type TransactionOptions_ReadWriteJson = {
  /**
   * An optional transaction to retry.
   *
   * @generated from field: bytes retry_transaction = 1;
 ...
 */
export const TransactionOptions_ReadWriteSchema: GenMessage<TransactionOptions_ReadWrite, {jsonType: TransactionOptions_ReadWriteJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.TransactionOptions.ReadOnly
 */
export type TransactionOptions_ReadOnlyJson = {
  /**
   * Reads documents at the given time.
   *
   * This must be a microsecond precision timestamp within the past one
 ...
 */
export const TransactionOptions_ReadOnlySchema: GenMessage<TransactionOptions_ReadOnly, {jsonType: TransactionOptions_ReadOnlyJson}> = /*@__PURE__*/
