...
// @generated by protoc-gen-es v2.12.0 with parameter "target=ts,json_types=true,import_extension=ts"
...
import { file_google_api_annotations } from "../../api/annotations_pb.ts";
import { file_google_api_client } from "../../api/client_pb.ts";
import { file_google_api_field_behavior } from "../../api/field_behavior_pb.ts";
import { file_google_api_routing } from "../../api/routing_pb.ts";
import type { AggregationResult, AggregationResultJson } from "./aggregation_result_pb.ts";
import { file_google_firestore_v1_aggregation_result } from "./aggregation_result_pb.ts";
import type { DocumentMask, DocumentMaskJson, Precondition, PreconditionJson, TransactionOptions, TransactionOptionsJson } from "./common_pb.ts";
import { file_google_firestore_v1_common } from "./common_pb.ts";
import type { Document, DocumentJson, DocumentSchema } from "./document_pb.ts";
import { file_google_firestore_v1_document } from "./document_pb.ts";
import type { ExplainStats, ExplainStatsJson } from "./explain_stats_pb.ts";
import { file_google_firestore_v1_explain_stats } from "./explain_stats_pb.ts";
import type { StructuredPipeline, StructuredPipelineJson } from "./pipeline_pb.ts";
import { file_google_firestore_v1_pipeline } from "./pipeline_pb.ts";
import type { Cursor, CursorJson, StructuredAggregationQuery, StructuredAggregationQueryJson, StructuredQuery, StructuredQueryJson } from "./query_pb.ts";
import { file_google_firestore_v1_query } from "./query_pb.ts";
import type { ExplainMetrics, ExplainMetricsJson, ExplainOptions, ExplainOptionsJson } from "./query_profile_pb.ts";
import { file_google_firestore_v1_query_profile } from "./query_profile_pb.ts";
import type { DocumentChange, DocumentChangeJson, DocumentDelete, DocumentDeleteJson, DocumentRemove, DocumentRemoveJson, ExistenceFilter, ExistenceFilterJson, Write, WriteJson, WriteResult, WriteResultJson } from "./write_pb.ts";
import { file_google_firestore_v1_write } from "./write_pb.ts";
import type { EmptySchema } from "../../protobuf/empty_pb.ts";
import { file_google_protobuf_empty } from "../../protobuf/empty_pb.ts";
import type { Timestamp, TimestampJson } from "../../protobuf/timestamp_pb.ts";
import { file_google_protobuf_timestamp } from "../../protobuf/timestamp_pb.ts";
import type { Int32ValueJson } from "../../protobuf/wrappers_pb.ts";
import { file_google_protobuf_wrappers } from "../../protobuf/wrappers_pb.ts";
import type { Status, StatusJson } from "../../rpc/status_pb.ts";
import { file_google_rpc_status } from "../../rpc/status_pb.ts";
...
export const file_google_firestore_v1_firestore: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_annotations, file_google_api_client, file_google_api_field_behavior, file_google_api_routing, file_google_firestore_v1_aggregation_result, file_google_firestore_v1_common, file_google_firestore_v1_document, file_google_firestore_v1_explain_stats, file_google_firestore_v1_pipeline, file_google_firestore_v1_query, file_google_firestore_v1_query_profile, file_google_firestore_v1_write, file_google_protobuf_empty, file_google_protobuf_timestamp, file_google_protobuf_wrappers, file_google_rpc_status]);
 ...
 * @generated from message google.firestore.v1.GetDocumentRequest
 */
export type GetDocumentRequestJson = {
  /**
   * Required. The resource name of the Document to get. In the format:
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   *
 ...
 */
export const GetDocumentRequestSchema: GenMessage<GetDocumentRequest, {jsonType: GetDocumentRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.ListDocumentsRequest
 */
export type ListDocumentsRequestJson = {
  /**
   * Required. The parent resource name. In the format:
   * `projects/{project_id}/databases/{database_id}/documents` or
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
 ...
 */
export const ListDocumentsRequestSchema: GenMessage<ListDocumentsRequest, {jsonType: ListDocumentsRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.ListDocumentsResponse
 */
export type ListDocumentsResponseJson = {
  /**
   * The Documents found.
   *
   * @generated from field: repeated google.firestore.v1.Document documents = 1;
 ...
 */
export const ListDocumentsResponseSchema: GenMessage<ListDocumentsResponse, {jsonType: ListDocumentsResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.CreateDocumentRequest
 */
export type CreateDocumentRequestJson = {
  /**
   * Required. The parent resource. For example:
   * `projects/{project_id}/databases/{database_id}/documents` or
   * `projects/{project_id}/databases/{database_id}/documents/chatrooms/{chatroom_id}`
 ...
 */
export const CreateDocumentRequestSchema: GenMessage<CreateDocumentRequest, {jsonType: CreateDocumentRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.UpdateDocumentRequest
 */
export type UpdateDocumentRequestJson = {
  /**
   * Required. The updated document.
   * Creates the document if it does not already exist.
   *
   ...
   * @generated from field: google.firestore.v1.Precondition current_document = 4;
   */
  currentDocument?: PreconditionJson;
};
 ...
 */
export const UpdateDocumentRequestSchema: GenMessage<UpdateDocumentRequest, {jsonType: UpdateDocumentRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.DeleteDocumentRequest
 */
export type DeleteDocumentRequestJson = {
  /**
   * Required. The resource name of the Document to delete. In the format:
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   *
 ...
 */
export const DeleteDocumentRequestSchema: GenMessage<DeleteDocumentRequest, {jsonType: DeleteDocumentRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BatchGetDocumentsRequest
 */
export type BatchGetDocumentsRequestJson = {
  /**
   * Required. The database name. In the format:
   * `projects/{project_id}/databases/{database_id}`.
   *
   ...
   * @generated from field: google.firestore.v1.TransactionOptions new_transaction = 5;
   */
  newTransaction?: TransactionOptionsJson;
 ...
 */
export const BatchGetDocumentsRequestSchema: GenMessage<BatchGetDocumentsRequest, {jsonType: BatchGetDocumentsRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BatchGetDocumentsResponse
 */
export type BatchGetDocumentsResponseJson = {
  /**
   * A document that was requested.
   *
   * @generated from field: google.firestore.v1.Document found = 1;
 ...
 */
export const BatchGetDocumentsResponseSchema: GenMessage<BatchGetDocumentsResponse, {jsonType: BatchGetDocumentsResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BeginTransactionRequest
 */
export type BeginTransactionRequestJson = {
  /**
   * Required. The database name. In the format:
   * `projects/{project_id}/databases/{database_id}`.
   *
   ...
   * @generated from field: google.firestore.v1.TransactionOptions options = 2;
   */
  options?: TransactionOptionsJson;
};
 ...
 */
export const BeginTransactionRequestSchema: GenMessage<BeginTransactionRequest, {jsonType: BeginTransactionRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BeginTransactionResponse
 */
export type BeginTransactionResponseJson = {
  /**
   * The transaction that was started.
   *
   * @generated from field: bytes transaction = 1;
 ...
 */
export const BeginTransactionResponseSchema: GenMessage<BeginTransactionResponse, {jsonType: BeginTransactionResponseJson}> = /*@__PURE__*/
 ...
 */
export const CommitRequestSchema: GenMessage<CommitRequest, {jsonType: CommitRequestJson}> = /*@__PURE__*/
...
export type CommitResponse = Message<"google.firestore.v1.CommitResponse"> & {
   ...
   */
  commitTime?: Timestamp | undefined;
};
 ...
 */
export const CommitResponseSchema: GenMessage<CommitResponse, {jsonType: CommitResponseJson}> = /*@__PURE__*/
 ...
 */
export const RollbackRequestSchema: GenMessage<RollbackRequest, {jsonType: RollbackRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.RunQueryRequest
 */
export type RunQueryRequestJson = {
  /**
   * Required. The parent resource name. In the format:
   * `projects/{project_id}/databases/{database_id}/documents` or
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   ...
   * @generated from field: google.firestore.v1.StructuredQuery structured_query = 2;
   */
  structuredQuery?: StructuredQueryJson;
   ...
   * @generated from field: google.firestore.v1.ExplainOptions explain_options = 10;
   */
  explainOptions?: ExplainOptionsJson;
};
 ...
 */
export const RunQueryRequestSchema: GenMessage<RunQueryRequest, {jsonType: RunQueryRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.RunQueryResponse
 */
export type RunQueryResponseJson = {
  /**
   * The transaction that was started as part of this request.
   * Can only be set in the first response, and only if
   * [RunQueryRequest.new_transaction][google.firestore.v1.RunQueryRequest.new_transaction]
   ...
   * @generated from field: google.firestore.v1.ExplainMetrics explain_metrics = 11;
   */
  explainMetrics?: ExplainMetricsJson;
};
 ...
 */
export const RunQueryResponseSchema: GenMessage<RunQueryResponse, {jsonType: RunQueryResponseJson}> = /*@__PURE__*/
 ...
 *
 * @generated from message google.firestore.v1.ExecutePipelineRequest
 */
export type ExecutePipelineRequest = Message<"google.firestore.v1.ExecutePipelineRequest"> & {
  /**
  ...
  /**
   * @generated from oneof google.firestore.v1.ExecutePipelineRequest.pipeline_type
   */
  pipelineType: {
    /**
     * A pipelined operation.
     *
     * @generated from field: google.firestore.v1.StructuredPipeline structured_pipeline = 2;
     */
    value: StructuredPipeline;
    case: "structuredPipeline";
  } | { case: undefined; value?: undefined };

  /**
   * Optional consistency arguments, defaults to strong consistency.
   *
   * @generated from oneof google.firestore.v1.ExecutePipelineRequest.consistency_selector
   */
  consistencySelector: {
    /**
     * Run the query within an already active transaction.
 ...
 * @generated from message google.firestore.v1.ExecutePipelineRequest
 */
export type ExecutePipelineRequestJson = {
  /**
   * Required. Database identifier, in the form
   * `projects/{project}/databases/{database}`.
   *
   ...
   * @generated from field: google.firestore.v1.StructuredPipeline structured_pipeline = 2;
   */
  structuredPipeline?: StructuredPipelineJson;
...
/**
 * Describes the message google.firestore.v1.ExecutePipelineRequest.
 * Use `create(ExecutePipelineRequestSchema)` to create a new message.
 */
export const ExecutePipelineRequestSchema: GenMessage<ExecutePipelineRequest, {jsonType: ExecutePipelineRequestJson}> = /*@__PURE__*/
  messageDesc(file_google_firestore_v1_firestore, 15);

/**
 * The response for [Firestore.Execute][].
 *
 * @generated from message google.firestore.v1.ExecutePipelineResponse
 */
export type ExecutePipelineResponse = Message<"google.firestore.v1.ExecutePipelineResponse"> & {
  /**
   ...
   *
   * @generated from field: repeated google.firestore.v1.Document results = 2;
   */
  results: Document[];
   ...
   *
   * @generated from field: google.firestore.v1.ExplainStats explain_stats = 4;
   */
  explainStats?: ExplainStats | undefined;
};
 ...
 * @generated from message google.firestore.v1.ExecutePipelineResponse
 */
export type ExecutePipelineResponseJson = {
  /**
   * Newly created transaction identifier.
   *
   * This field is only specified as part of the first response from the server,
   ...
   * @generated from field: google.firestore.v1.ExplainStats explain_stats = 4;
   */
  explainStats?: ExplainStatsJson;
};

/**
 * Describes the message google.firestore.v1.ExecutePipelineResponse.
 * Use `create(ExecutePipelineResponseSchema)` to create a new message.
 */
export const ExecutePipelineResponseSchema: GenMessage<ExecutePipelineResponse, {jsonType: ExecutePipelineResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.RunAggregationQueryRequest
 */
export type RunAggregationQueryRequestJson = {
  /**
   * Required. The parent resource name. In the format:
   * `projects/{project_id}/databases/{database_id}/documents` or
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   ...
   * @generated from field: google.firestore.v1.StructuredAggregationQuery structured_aggregation_query = 2;
   */
  structuredAggregationQuery?: StructuredAggregationQueryJson;
 ...
 */
export const RunAggregationQueryRequestSchema: GenMessage<RunAggregationQueryRequest, {jsonType: RunAggregationQueryRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.RunAggregationQueryResponse
 */
export type RunAggregationQueryResponseJson = {
  /**
   * A single aggregation result.
   *
   * Not present when reporting partial progress.
 ...
 */
export const RunAggregationQueryResponseSchema: GenMessage<RunAggregationQueryResponse, {jsonType: RunAggregationQueryResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.PartitionQueryRequest
 */
export type PartitionQueryRequestJson = {
  /**
   * Required. The parent resource name. In the format:
   * `projects/{project_id}/databases/{database_id}/documents`.
   * Document resource names are not supported; only database resource names
 ...
 */
export const PartitionQueryRequestSchema: GenMessage<PartitionQueryRequest, {jsonType: PartitionQueryRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.PartitionQueryResponse
 */
export type PartitionQueryResponseJson = {
  /**
   * Partition results.
   * Each partition is a split point that can be used by RunQuery as a starting
   * or end point for the query results. The RunQuery requests must be made with
 ...
 */
export const PartitionQueryResponseSchema: GenMessage<PartitionQueryResponse, {jsonType: PartitionQueryResponseJson}> = /*@__PURE__*/
 ...
 */
export const WriteRequestSchema: GenMessage<WriteRequest, {jsonType: WriteRequestJson}> = /*@__PURE__*/
 ...
 */
export const WriteResponseSchema: GenMessage<WriteResponse, {jsonType: WriteResponseJson}> = /*@__PURE__*/
 ...
 */
export const ListenRequestSchema: GenMessage<ListenRequest, {jsonType: ListenRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.ListenResponse
 */
export type ListenResponseJson = {
  /**
   * Targets have changed.
   *
   * @generated from field: google.firestore.v1.TargetChange target_change = 2;
   */
  targetChange?: TargetChangeJson;
   ...
   * @generated from field: google.firestore.v1.DocumentChange document_change = 3;
   */
  documentChange?: DocumentChangeJson;
   ...
   * @generated from field: google.firestore.v1.DocumentDelete document_delete = 4;
   */
  documentDelete?: DocumentDeleteJson;
   ...
   * @generated from field: google.firestore.v1.DocumentRemove document_remove = 6;
   */
  documentRemove?: DocumentRemoveJson;
 ...
 */
export const ListenResponseSchema: GenMessage<ListenResponse, {jsonType: ListenResponseJson}> = /*@__PURE__*/
...
export type TargetJson = {
   ...
   * @generated from field: google.firestore.v1.Target.DocumentsTarget documents = 3;
   */
  documents?: Target_DocumentsTargetJson;
 ...
 * @generated from message google.firestore.v1.Target.DocumentsTarget
 */
export type Target_DocumentsTargetJson = {
  /**
   * The names of the documents to retrieve. In the format:
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   * The request will fail if any of the document is not a child resource of
 ...
 */
export const Target_DocumentsTargetSchema: GenMessage<Target_DocumentsTarget, {jsonType: Target_DocumentsTargetJson}> = /*@__PURE__*/
  messageDesc(file_google_firestore_v1_firestore, 25, 0);
 ...
 * @generated from message google.firestore.v1.Target.QueryTarget
 */
export type Target_QueryTargetJson = {
  /**
   * The parent resource name. In the format:
   * `projects/{project_id}/databases/{database_id}/documents` or
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
 ...
 */
export const Target_QueryTargetSchema: GenMessage<Target_QueryTarget, {jsonType: Target_QueryTargetJson}> = /*@__PURE__*/
  messageDesc(file_google_firestore_v1_firestore, 25, 1);
 ...
 * @generated from message google.firestore.v1.TargetChange
 */
export type TargetChangeJson = {
  /**
   * The type of change that occurred.
   *
   * @generated from field: google.firestore.v1.TargetChange.TargetChangeType target_change_type = 1;
   */
  targetChangeType?: TargetChange_TargetChangeTypeJson;
 ...
 */
export const TargetChangeSchema: GenMessage<TargetChange, {jsonType: TargetChangeJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.TargetChange.TargetChangeType
 */
export type TargetChange_TargetChangeTypeJson = "NO_CHANGE" | "ADD" | "REMOVE" | "CURRENT" | "RESET";

/**
 * Describes the enum google.firestore.v1.TargetChange.TargetChangeType.
 */
export const TargetChange_TargetChangeTypeSchema: GenEnum<TargetChange_TargetChangeType, TargetChange_TargetChangeTypeJson> = /*@__PURE__*/
  enumDesc(file_google_firestore_v1_firestore, 26, 0);
 ...
 * @generated from message google.firestore.v1.ListCollectionIdsRequest
 */
export type ListCollectionIdsRequestJson = {
  /**
   * Required. The parent document. In the format:
   * `projects/{project_id}/databases/{database_id}/documents/{document_path}`.
   * For example:
 ...
 */
export const ListCollectionIdsRequestSchema: GenMessage<ListCollectionIdsRequest, {jsonType: ListCollectionIdsRequestJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.ListCollectionIdsResponse
 */
export type ListCollectionIdsResponseJson = {
  /**
   * The collection ids.
   *
   * @generated from field: repeated string collection_ids = 1;
 ...
 */
export const ListCollectionIdsResponseSchema: GenMessage<ListCollectionIdsResponse, {jsonType: ListCollectionIdsResponseJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BatchWriteRequest
 */
export type BatchWriteRequestJson = {
  /**
   * Required. The database name. In the format:
   * `projects/{project_id}/databases/{database_id}`.
   *
 ...
 */
export const BatchWriteRequestSchema: GenMessage<BatchWriteRequest, {jsonType: BatchWriteRequestJson}> = /*@__PURE__*/
  messageDesc(file_google_firestore_v1_firestore, 29);
 ...
 * @generated from message google.firestore.v1.BatchWriteResponse
 */
export type BatchWriteResponseJson = {
  /**
   * The result of applying the writes.
   *
   * This i-th write result corresponds to the i-th write in the
 ...
 */
export const BatchWriteResponseSchema: GenMessage<BatchWriteResponse, {jsonType: BatchWriteResponseJson}> = /*@__PURE__*/
  messageDesc(file_google_firestore_v1_firestore, 30);
...
export const Firestore: GenService<{
   ...
   *
   * @generated from rpc google.firestore.v1.Firestore.ExecutePipeline
   */
  executePipeline: {
    methodKind: "server_streaming";
    input: typeof ExecutePipelineRequestSchema;
    output: typeof ExecutePipelineResponseSchema;
  },
  /**
