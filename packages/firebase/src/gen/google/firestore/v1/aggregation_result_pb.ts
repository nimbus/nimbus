 ...
 * @generated from message google.firestore.v1.AggregationResult
 */
export type AggregationResultJson = {
  /**
   * The result of the aggregation functions, ex: `COUNT(*) AS total_docs`.
   *
   * The key is the
   ...
   * @generated from field: map<string, google.firestore.v1.Value> aggregate_fields = 2;
   */
  aggregateFields?: { [key: string]: ValueJson };
};
 ...
 */
export const AggregationResultSchema: GenMessage<AggregationResult, {jsonType: AggregationResultJson}> = /*@__PURE__*/
