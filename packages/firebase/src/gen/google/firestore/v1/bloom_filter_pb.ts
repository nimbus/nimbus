 ...
 */
export const BitSequenceSchema: GenMessage<BitSequence, {jsonType: BitSequenceJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.BloomFilter
 */
export type BloomFilterJson = {
  /**
   * The bloom filter data.
   *
   * @generated from field: google.firestore.v1.BitSequence bits = 1;
   */
  bits?: BitSequenceJson;
 ...
 */
export const BloomFilterSchema: GenMessage<BloomFilter, {jsonType: BloomFilterJson}> = /*@__PURE__*/
