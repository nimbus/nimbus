...
import type { Value, ValueJson } from "./document_pb.ts";
import { file_google_firestore_v1_document } from "./document_pb.ts";
import type { DoubleValueJson, Int32ValueJson, Int64ValueJson } from "../../protobuf/wrappers_pb.ts";
...
export type StructuredQuery = Message<"google.firestore.v1.StructuredQuery"> & {
   ...
   */
  select?: StructuredQuery_Projection | undefined;
   ...
   */
  where?: StructuredQuery_Filter | undefined;
 ...
 * @generated from message google.firestore.v1.StructuredQuery
 */
export type StructuredQueryJson = {
  /**
   * Optional sub-set of the fields to return.
   *
   * This acts as a [DocumentMask][google.firestore.v1.DocumentMask] over the
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.Projection select = 1;
   */
  select?: StructuredQuery_ProjectionJson;
   ...
   * @generated from field: repeated google.firestore.v1.StructuredQuery.CollectionSelector from = 2;
   */
  from?: StructuredQuery_CollectionSelectorJson[];
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.Filter where = 3;
   */
  where?: StructuredQuery_FilterJson;
   ...
   * @generated from field: repeated google.firestore.v1.StructuredQuery.Order order_by = 4;
   */
  orderBy?: StructuredQuery_OrderJson[];
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.FindNearest find_nearest = 9;
   */
  findNearest?: StructuredQuery_FindNearestJson;
};
 ...
 */
export const StructuredQuerySchema: GenMessage<StructuredQuery, {jsonType: StructuredQueryJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.CollectionSelector
 */
export type StructuredQuery_CollectionSelectorJson = {
  /**
   * The collection ID.
   * When set, selects only collections with this ID.
   *
 ...
 */
export const StructuredQuery_CollectionSelectorSchema: GenMessage<StructuredQuery_CollectionSelector, {jsonType: StructuredQuery_CollectionSelectorJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.Filter
 */
export type StructuredQuery_FilterJson = {
  /**
   * A composite filter.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.CompositeFilter composite_filter = 1;
   */
  compositeFilter?: StructuredQuery_CompositeFilterJson;
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.FieldFilter field_filter = 2;
   */
  fieldFilter?: StructuredQuery_FieldFilterJson;
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.UnaryFilter unary_filter = 3;
   */
  unaryFilter?: StructuredQuery_UnaryFilterJson;
};
 ...
 */
export const StructuredQuery_FilterSchema: GenMessage<StructuredQuery_Filter, {jsonType: StructuredQuery_FilterJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.CompositeFilter
 */
export type StructuredQuery_CompositeFilterJson = {
  /**
   * The operator for combining multiple filters.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.CompositeFilter.Operator op = 1;
   */
  op?: StructuredQuery_CompositeFilter_OperatorJson;
   ...
   * @generated from field: repeated google.firestore.v1.StructuredQuery.Filter filters = 2;
   */
  filters?: StructuredQuery_FilterJson[];
};
 ...
 */
export const StructuredQuery_CompositeFilterSchema: GenMessage<StructuredQuery_CompositeFilter, {jsonType: StructuredQuery_CompositeFilterJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.StructuredQuery.CompositeFilter.Operator
 */
export type StructuredQuery_CompositeFilter_OperatorJson = "OPERATOR_UNSPECIFIED" | "AND" | "OR";

/**
 * Describes the enum google.firestore.v1.StructuredQuery.CompositeFilter.Operator.
 */
export const StructuredQuery_CompositeFilter_OperatorSchema: GenEnum<StructuredQuery_CompositeFilter_Operator, StructuredQuery_CompositeFilter_OperatorJson> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.FieldFilter
 */
export type StructuredQuery_FieldFilterJson = {
  /**
   * The field to filter by.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.FieldReference field = 1;
   */
  field?: StructuredQuery_FieldReferenceJson;
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.FieldFilter.Operator op = 2;
   */
  op?: StructuredQuery_FieldFilter_OperatorJson;
 ...
 */
export const StructuredQuery_FieldFilterSchema: GenMessage<StructuredQuery_FieldFilter, {jsonType: StructuredQuery_FieldFilterJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.StructuredQuery.FieldFilter.Operator
 */
export type StructuredQuery_FieldFilter_OperatorJson = "OPERATOR_UNSPECIFIED" | "LESS_THAN" | "LESS_THAN_OR_EQUAL" | "GREATER_THAN" | "GREATER_THAN_OR_EQUAL" | "EQUAL" | "NOT_EQUAL" | "ARRAY_CONTAINS" | "IN" | "ARRAY_CONTAINS_ANY" | "NOT_IN";

/**
 * Describes the enum google.firestore.v1.StructuredQuery.FieldFilter.Operator.
 */
export const StructuredQuery_FieldFilter_OperatorSchema: GenEnum<StructuredQuery_FieldFilter_Operator, StructuredQuery_FieldFilter_OperatorJson> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.UnaryFilter
 */
export type StructuredQuery_UnaryFilterJson = {
  /**
   * The unary operator to apply.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.UnaryFilter.Operator op = 1;
   */
  op?: StructuredQuery_UnaryFilter_OperatorJson;
 ...
 */
export const StructuredQuery_UnaryFilterSchema: GenMessage<StructuredQuery_UnaryFilter, {jsonType: StructuredQuery_UnaryFilterJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.StructuredQuery.UnaryFilter.Operator
 */
export type StructuredQuery_UnaryFilter_OperatorJson = "OPERATOR_UNSPECIFIED" | "IS_NAN" | "IS_NULL" | "IS_NOT_NAN" | "IS_NOT_NULL";

/**
 * Describes the enum google.firestore.v1.StructuredQuery.UnaryFilter.Operator.
 */
export const StructuredQuery_UnaryFilter_OperatorSchema: GenEnum<StructuredQuery_UnaryFilter_Operator, StructuredQuery_UnaryFilter_OperatorJson> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.Order
 */
export type StructuredQuery_OrderJson = {
  /**
   * The field to order by.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.FieldReference field = 1;
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.Direction direction = 2;
   */
  direction?: StructuredQuery_DirectionJson;
};
 ...
 */
export const StructuredQuery_OrderSchema: GenMessage<StructuredQuery_Order, {jsonType: StructuredQuery_OrderJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.FieldReference
 */
export type StructuredQuery_FieldReferenceJson = {
  /**
   * A reference to a field in a document.
   *
   * Requires:
 ...
 */
export const StructuredQuery_FieldReferenceSchema: GenMessage<StructuredQuery_FieldReference, {jsonType: StructuredQuery_FieldReferenceJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredQuery.Projection
 */
export type StructuredQuery_ProjectionJson = {
  /**
   * The fields to return.
   *
   * If empty, all fields are returned. To only return the name
   ...
   * @generated from field: repeated google.firestore.v1.StructuredQuery.FieldReference fields = 2;
   */
  fields?: StructuredQuery_FieldReferenceJson[];
};
 ...
 */
export const StructuredQuery_ProjectionSchema: GenMessage<StructuredQuery_Projection, {jsonType: StructuredQuery_ProjectionJson}> = /*@__PURE__*/
...
export type StructuredQuery_FindNearest = Message<"google.firestore.v1.StructuredQuery.FindNearest"> & {
   ...
   */
  vectorField?: StructuredQuery_FieldReference | undefined;
 ...
 * @generated from message google.firestore.v1.StructuredQuery.FindNearest
 */
export type StructuredQuery_FindNearestJson = {
  /**
   * Required. An indexed vector field to search upon. Only documents which
   * contain vectors whose dimensionality match the query_vector can be
   * returned.
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.FieldReference vector_field = 1;
   */
  vectorField?: StructuredQuery_FieldReferenceJson;
   ...
   * @generated from field: google.firestore.v1.StructuredQuery.FindNearest.DistanceMeasure distance_measure = 3;
   */
  distanceMeasure?: StructuredQuery_FindNearest_DistanceMeasureJson;
   ...
   * @generated from field: google.protobuf.DoubleValue distance_threshold = 6;
   */
  distanceThreshold?: DoubleValueJson;
};
 ...
 */
export const StructuredQuery_FindNearestSchema: GenMessage<StructuredQuery_FindNearest, {jsonType: StructuredQuery_FindNearestJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.StructuredQuery.FindNearest.DistanceMeasure
 */
export type StructuredQuery_FindNearest_DistanceMeasureJson = "DISTANCE_MEASURE_UNSPECIFIED" | "EUCLIDEAN" | "COSINE" | "DOT_PRODUCT";

/**
 * Describes the enum google.firestore.v1.StructuredQuery.FindNearest.DistanceMeasure.
 */
export const StructuredQuery_FindNearest_DistanceMeasureSchema: GenEnum<StructuredQuery_FindNearest_DistanceMeasure, StructuredQuery_FindNearest_DistanceMeasureJson> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.StructuredQuery.Direction
 */
export type StructuredQuery_DirectionJson = "DIRECTION_UNSPECIFIED" | "ASCENDING" | "DESCENDING";

/**
 * Describes the enum google.firestore.v1.StructuredQuery.Direction.
 */
export const StructuredQuery_DirectionSchema: GenEnum<StructuredQuery_Direction, StructuredQuery_DirectionJson> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredAggregationQuery
 */
export type StructuredAggregationQueryJson = {
  /**
   * Nested structured query.
   *
   * @generated from field: google.firestore.v1.StructuredQuery structured_query = 1;
   ...
   * @generated from field: repeated google.firestore.v1.StructuredAggregationQuery.Aggregation aggregations = 3;
   */
  aggregations?: StructuredAggregationQuery_AggregationJson[];
};
 ...
 */
export const StructuredAggregationQuerySchema: GenMessage<StructuredAggregationQuery, {jsonType: StructuredAggregationQueryJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredAggregationQuery.Aggregation
 */
export type StructuredAggregationQuery_AggregationJson = {
  /**
   * Count aggregator.
   *
   * @generated from field: google.firestore.v1.StructuredAggregationQuery.Aggregation.Count count = 1;
   */
  count?: StructuredAggregationQuery_Aggregation_CountJson;
   ...
   * @generated from field: google.firestore.v1.StructuredAggregationQuery.Aggregation.Sum sum = 2;
   */
  sum?: StructuredAggregationQuery_Aggregation_SumJson;
   ...
   * @generated from field: google.firestore.v1.StructuredAggregationQuery.Aggregation.Avg avg = 3;
   */
  avg?: StructuredAggregationQuery_Aggregation_AvgJson;
 ...
 */
export const StructuredAggregationQuery_AggregationSchema: GenMessage<StructuredAggregationQuery_Aggregation, {jsonType: StructuredAggregationQuery_AggregationJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredAggregationQuery.Aggregation.Count
 */
export type StructuredAggregationQuery_Aggregation_CountJson = {
  /**
   * Optional. Optional constraint on the maximum number of documents to
   * count.
   *
 ...
 */
export const StructuredAggregationQuery_Aggregation_CountSchema: GenMessage<StructuredAggregationQuery_Aggregation_Count, {jsonType: StructuredAggregationQuery_Aggregation_CountJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredAggregationQuery.Aggregation.Sum
 */
export type StructuredAggregationQuery_Aggregation_SumJson = {
  /**
   * The field to aggregate on.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.FieldReference field = 1;
 ...
 */
export const StructuredAggregationQuery_Aggregation_SumSchema: GenMessage<StructuredAggregationQuery_Aggregation_Sum, {jsonType: StructuredAggregationQuery_Aggregation_SumJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.StructuredAggregationQuery.Aggregation.Avg
 */
export type StructuredAggregationQuery_Aggregation_AvgJson = {
  /**
   * The field to aggregate on.
   *
   * @generated from field: google.firestore.v1.StructuredQuery.FieldReference field = 1;
 ...
 */
export const StructuredAggregationQuery_Aggregation_AvgSchema: GenMessage<StructuredAggregationQuery_Aggregation_Avg, {jsonType: StructuredAggregationQuery_Aggregation_AvgJson}> = /*@__PURE__*/
