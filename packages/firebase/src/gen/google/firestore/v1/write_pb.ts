...
import type { BloomFilter, BloomFilterJson } from "./bloom_filter_pb.ts";
import { file_google_firestore_v1_bloom_filter } from "./bloom_filter_pb.ts";
import type { DocumentMask, DocumentMaskJson, Precondition, PreconditionJson } from "./common_pb.ts";
import { file_google_firestore_v1_common } from "./common_pb.ts";
import type { ArrayValue, ArrayValueJson, Document, DocumentJson, Value, ValueJson } from "./document_pb.ts";
...
export const file_google_firestore_v1_write: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_firestore_v1_bloom_filter, file_google_firestore_v1_common, file_google_firestore_v1_document, file_google_protobuf_timestamp]);
...
export type Write = Message<"google.firestore.v1.Write"> & {
  ...
  operation: {
     ...
     *
     * @generated from field: string verify = 5;
     */
    value: string;
    case: "verify";
  } | {
...
export type WriteJson = {
   ...
   * @generated from field: google.firestore.v1.DocumentTransform transform = 6;
   */
  transform?: DocumentTransformJson;
   ...
   * @generated from field: repeated google.firestore.v1.DocumentTransform.FieldTransform update_transforms = 7;
   */
  updateTransforms?: DocumentTransform_FieldTransformJson[];
 ...
 */
export const WriteSchema: GenMessage<Write, {jsonType: WriteJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.DocumentTransform
 */
export type DocumentTransformJson = {
  /**
   * The name of the document to transform.
   *
   * @generated from field: string document = 1;
   ...
   * @generated from field: repeated google.firestore.v1.DocumentTransform.FieldTransform field_transforms = 2;
   */
  fieldTransforms?: DocumentTransform_FieldTransformJson[];
};
 ...
 */
export const DocumentTransformSchema: GenMessage<DocumentTransform, {jsonType: DocumentTransformJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.DocumentTransform.FieldTransform
 */
export type DocumentTransform_FieldTransformJson = {
  /**
   * The path of the field. See
   * [Document.fields][google.firestore.v1.Document.fields] for the field path
   * syntax reference.
   ...
   * @generated from field: google.firestore.v1.DocumentTransform.FieldTransform.ServerValue set_to_server_value = 2;
   */
  setToServerValue?: DocumentTransform_FieldTransform_ServerValueJson;
   ...
   * @generated from field: google.firestore.v1.ArrayValue append_missing_elements = 6;
   */
  appendMissingElements?: ArrayValueJson;
   ...
   * @generated from field: google.firestore.v1.ArrayValue remove_all_from_array = 7;
   */
  removeAllFromArray?: ArrayValueJson;
};
 ...
 */
export const DocumentTransform_FieldTransformSchema: GenMessage<DocumentTransform_FieldTransform, {jsonType: DocumentTransform_FieldTransformJson}> = /*@__PURE__*/
 ...
 * @generated from enum google.firestore.v1.DocumentTransform.FieldTransform.ServerValue
 */
export type DocumentTransform_FieldTransform_ServerValueJson = "SERVER_VALUE_UNSPECIFIED" | "REQUEST_TIME";

/**
 * Describes the enum google.firestore.v1.DocumentTransform.FieldTransform.ServerValue.
 */
export const DocumentTransform_FieldTransform_ServerValueSchema: GenEnum<DocumentTransform_FieldTransform_ServerValue, DocumentTransform_FieldTransform_ServerValueJson> = /*@__PURE__*/
 ...
 */
export const WriteResultSchema: GenMessage<WriteResult, {jsonType: WriteResultJson}> = /*@__PURE__*/
 ...
 */
export const DocumentChangeSchema: GenMessage<DocumentChange, {jsonType: DocumentChangeJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.DocumentDelete
 */
export type DocumentDeleteJson = {
  /**
   * The resource name of the [Document][google.firestore.v1.Document] that was
   * deleted.
   *
 ...
 */
export const DocumentDeleteSchema: GenMessage<DocumentDelete, {jsonType: DocumentDeleteJson}> = /*@__PURE__*/
 ...
 * @generated from message google.firestore.v1.DocumentRemove
 */
export type DocumentRemoveJson = {
  /**
   * The resource name of the [Document][google.firestore.v1.Document] that has
   * gone out of view.
   *
 ...
 */
export const DocumentRemoveSchema: GenMessage<DocumentRemove, {jsonType: DocumentRemoveJson}> = /*@__PURE__*/
...
export type ExistenceFilter = Message<"google.firestore.v1.ExistenceFilter"> & {
   ...
   */
  unchangedNames?: BloomFilter | undefined;
};
 ...
 * @generated from message google.firestore.v1.ExistenceFilter
 */
export type ExistenceFilterJson = {
  /**
   * The target ID to which this filter applies.
   *
   * @generated from field: int32 target_id = 1;
   ...
   * @generated from field: google.firestore.v1.BloomFilter unchanged_names = 3;
   */
  unchangedNames?: BloomFilterJson;
};
 ...
 */
export const ExistenceFilterSchema: GenMessage<ExistenceFilter, {jsonType: ExistenceFilterJson}> = /*@__PURE__*/
